...
GCE metadata instance document to authenticate to Istio Citadel. For everything
...
installation of Istio includes Istio Citadel and will generate Istio secrets even if
the automatic 'mTLS'
