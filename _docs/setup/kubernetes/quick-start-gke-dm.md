...
1. Once you have an account and project enabled, click the following link to open the Deployment Manager.
   ...
   GKE alpha cluster with the specified settings, then installs the Istio [control plane]({{home}}/docs/concepts/what-is-istio/overview
   .html#architecture), the [BookInfo](https://istio.io/docs/guides/bookinfo.html) sample app, [Grafana](https://istio.io/docs/tasks/telemetry/using-istio-dashboard.html) with [Prometheus](https://istio.io/docs/tasks/telemetry/querying-metrics.html), [ServiceGraph](https://istio.io/docs/tasks/telemetry/servicegraph.html), and [Zipkin](https://istio.io/docs/tasks/telemetry/distributed-tracing.html#zipkin). You'll find out more about how to access all of these below.
