...
*   Generate a [SPIFFE](spiffe.github.io/docs/svid) key and certificate pair for each service account
...
1.  Istio CA watches Kubernetes API Server, creates a [SPIFFE](spiffe.github.io/docs/svid) key and certificate pair for each of the existing and new service accounts, and sends them to API Server. 
