...
1.  [Istio Manager](https://github.com/istio/istio.github.io/blob/master/_docs/concepts/traffic-management/manager.md) generates the config with proper key and certificate and secure naming information, 
which
...
in [Mixer](https://github.com/istio/istio.github.io/blob/master/_docs/concepts/policy-and-control/mixer.html) such that photo-frontend cannot access datastore.
