...
Simply type crd help [path to command] for full details.
```
mixs crd help [command] [flags]
```
...
Help provides help for any command in the application.
Simply type mixs help [path to command] for full details.
```
mixs help [command] [flags]
```
