...
> Note: This assumes you don't have any default routes set yet. If you've already created default route rules for the sample, you'll need to use `replace` rather than `create` in the following command.
