...
This page summarizes frequently asked questions and the team can be reached via google groups
(https://groups.google.com/forum/#!forum/istio-users).
...
ApiServer cannot recognize Istio Auth issued certs. You can turn off Istio Auth to access ApiServer.
