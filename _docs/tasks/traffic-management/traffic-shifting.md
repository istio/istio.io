...
1. Refresh the `productpage` in your browser and you should now see *red* colored star ratings approximately 50% of the time.
   ...
   > to see the proper distribution. You may see all traffic goes to v1 in the initial ~15 refreshes. You can modify the rules to route 90% of the traffic to v3 to see red stars more often.
