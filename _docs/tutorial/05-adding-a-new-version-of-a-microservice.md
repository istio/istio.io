...
Enters [Istio service mesh](istio.io). Istio can perform the tasks mentioned here and much more. In the next steps, we will explore various good features Istio can provide.
