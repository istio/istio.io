"use strict";let scrollToTopButton,tocLinks,tocHeadings;function handleDOMLoaded(){function a(){scrollToTopButton=document.getElementById("scroll-to-top");const a=document.getElementById("toc");if(null!==a){tocLinks=a.getElementsByTagName("A"),tocHeadings=Array(tocLinks.length);for(let a=0;a<tocLinks.length;a++)tocHeadings[a]=document.getElementById(tocLinks[a].hash.substring(1))}}let b=!1;(function(){function a(a){const b=document.createElement("a");b.className="header-link",b.href="#"+a.id,b.setAttribute("aria-hidden","true"),b.innerHTML="<svg class='icon'><use xlink:href='"+iconFile+"#links'/></svg>",a.appendChild(b)}(function(){function a(a){const c=document.createElement("BUTTON");c.title=buttonCopy,c.className="copy",c.innerHTML="<svg><use xlink:href='"+iconFile+"#copy'/></svg>",c.setAttribute("aria-label","Copy to clipboard"),c.addEventListener("mouseenter",a=>a.currentTarget.classList.add("toolbar-show")),c.addEventListener("mouseleave",a=>a.currentTarget.classList.remove("toolbar-show"));const d=document.createElement("BUTTON");d.title=buttonDownload,d.className="download",d.innerHTML="<svg><use xlink:href='"+iconFile+"#download'/></svg>",d.setAttribute("aria-label",d.title),d.addEventListener("mouseenter",a=>a.currentTarget.classList.add("toolbar-show")),d.addEventListener("mouseleave",a=>a.currentTarget.classList.remove("toolbar-show")),d.addEventListener("click",a=>{const c=a.currentTarget.parentElement,d=c.getElementsByTagName("CODE");if(null!==d&&0<d.length){const a=d[0],e=b(c);let f=a.getAttribute("data-downloadas");if(null===f||""===f){let b="";for(let c=0;c<a.classList.length;c++)if(a.classList.item(c).startsWith("language-")){b=a.classList.item(c).substr(9);break}b.startsWith("command")?b="bash":"markdown"===b?b="md":""===b&&(b="txt"),f=docTitle+"."+b}saveFile(f,e)}return!0});const e=document.createElement("BUTTON");e.title=buttonPrint,e.className="print",e.innerHTML="<svg><use xlink:href='"+iconFile+"#printer'/></svg>",e.setAttribute("aria-label",e.title),e.addEventListener("mouseenter",a=>a.currentTarget.classList.add("toolbar-show")),e.addEventListener("mouseleave",a=>a.currentTarget.classList.remove("toolbar-show")),e.addEventListener("click",a=>{const c=a.currentTarget.parentElement,d=b(c);return printText(d),!0});const f=document.createElement("DIV");f.className="toolbar",a.parentElement.insertBefore(f,a),f.appendChild(a),f.appendChild(e),f.appendChild(d),f.appendChild(c),a.addEventListener("mouseenter",a=>{a.currentTarget.nextSibling.classList.add("toolbar-show"),a.currentTarget.nextSibling.nextSibling.classList.add("toolbar-show"),a.currentTarget.nextSibling.nextSibling.nextSibling.classList.add("toolbar-show")}),a.addEventListener("mouseleave",a=>{a.currentTarget.nextSibling.classList.remove("toolbar-show"),a.currentTarget.nextSibling.nextSibling.classList.remove("toolbar-show"),a.currentTarget.nextSibling.nextSibling.nextSibling.classList.remove("toolbar-show")})}function b(a){const b=a.getElementsByClassName("command");if(null!==b&&0<b.length){const a=b[0].innerText.split("\n");let c="";for(let b=0;b<a.length;b++)a[b].startsWith("$ ")&&(a[b]=a[b].substring(2)),""!==c&&(c+="\n"),c+=a[b];return c}return a.innerText}function c(a){const b=a.firstChild;let c="";for(let d=0;d<b.classList.length;d++)if(b.classList.item(d).startsWith("language-command")){c=b.classList.item(d);break}if(""!==c){let a=0,d=b.innerText.split("\n"),e="",f=!1,g=!1,h="";for(let b=0;b<d.length;b++){const c=d[b];if(c.startsWith("$ "))""!==h&&(e+="$ "+Prism.highlight(h,Prism.languages.bash,"bash")+"\n"),h=c.slice(2),c.includes("<<EOF")&&(g=!0);else if(f)h+="\n"+c,c.includes("<<EOF")&&(g=!0);else if(g)h+="\n"+c,"EOF"===c&&(g=!1);else{a=b;break}f=c.endsWith("\\")}if(""!==h&&(e+="$ "+Prism.highlight(h,Prism.languages.bash,"bash")+"\n"),""!==e){e=e.replace(/@(.*?)@/g,"<a href='https://raw.githubusercontent.com/istio/istio/"+branchName+"/$1'>$1</a>");let f="<div class='command'>"+e+"</div>",g="";if(0<a)for(let b=a;b<d.length;b++)""!==g&&(g+="\n"),g+=d[b];if(""!==g){if(c.startsWith("language-command-output-as-")){let a=c.substr("language-command-output-as-".length);g=Prism.highlight(g,Prism.languages[a],a)}else g=escapeHTML(g);f+="<div class='output'>"+g+"</div>"}b.innerHTML=f,b.classList.remove(c),b.classList.add("command-output")}else Prism.highlightElement(b,!1)}else Prism.highlightElement(b,!1)}function d(a){a.hasAttribute("data-src")&&function(a,b){fetch(b).then(function(a){return a.text()}).then(function(b){a.firstChild.textContent=b,Prism.highlightElement(a.firstChild,!1)})}(a,a.getAttribute("data-src"))}document.querySelectorAll("pre").forEach(b=>{a(b),c(b),d(b)});const e=new ClipboardJS("button.copy",{text:function(a){return b(a.parentElement)}});e.on("error",()=>alert("Sorry, but copying is not supported by your browser"))})(),function(){for(let b=2;6>=b;b++)document.querySelectorAll("h"+b.toString()).forEach(b=>{""!==b.id&&a(b)})}(),function(){document.querySelectorAll("dt").forEach(b=>{""!==b.id&&a(b)})}(),function(){document.querySelectorAll("a").forEach(a=>{a.hostname&&a.hostname!==location.hostname&&(a.setAttribute("target","_blank"),a.setAttribute("rel","noopener"))})}(),function(){const a=document.getElementById("endnotes");if(null===a)return;const b=document.getElementsByTagName("main")[0],c=new Map(null);let d=0;if(b.querySelectorAll("a").forEach(b=>{if(b.pathname===location.pathname)return;if(b.pathname.endsWith("/")&&""!==b.hash)return;if(b.classList.contains("btn"))return;if(b.classList.contains("not-for-endnotes"))return;let e=c.get(b.href);if(void 0===e){e=c.size+1,c.set(b.href,e);const d=document.createElement("li");d.innerText=b.href,a.appendChild(d)}b.insertAdjacentHTML("afterend","<sup class='endnote-ref'>"+e+"</sup>"),d++}),0==d){const a=document.getElementsByClassName("link-endnotes")[0];a.style.display="none"}}()})(),function(){document.querySelectorAll("a[data-toggle=\"tab\"]").forEach(a=>{const b=a.getAttribute("data-cookie-name"),c=a.getAttribute("data-cookie-value");if(null!==b&&""!==b){const d=readCookie(b);c===d&&$(".nav-tabs a[href=\""+a.hash+"\"]").tab("show")}})}(),a(),function(){function a(){document.getElementById("search_form").classList.remove("active"),document.getElementById("navbar-links").classList.add("active"),document.getElementById("search_textbox").value=""}function b(){document.getElementById("search_form").classList.add("active"),document.getElementById("navbar-links").classList.remove("active"),document.getElementById("search_textbox").focus()}document.body.addEventListener("keyup",b=>{27===b.which&&a()}),document.getElementById("search_show").addEventListener("click",a=>{a.preventDefault(),b()}),document.getElementById("search_close").addEventListener("click",b=>{b.preventDefault(),a()}),document.getElementById("search_form").addEventListener("submit",b=>{b.preventDefault();const c=document.getElementById("search_textbox"),d=document.getElementById("search_page_url"),e=d.value+"?q="+c.value;a(),window.location.assign(e)})}(),function(){document.getElementById("sidebar-toggler").addEventListener("click",a=>{document.getElementById("sidebar-container").classList.toggle("active"),a.currentTarget.querySelector("svg.icon").classList.toggle("flipped")}),document.querySelectorAll(".tree-toggle").forEach(a=>{a.addEventListener("click",()=>{a.querySelectorAll("i.chevron").forEach(a=>{a.classList.toggle("show")}),a.nextElementSibling.style.display="none"===a.nextElementSibling.style.display?"block":"none"})})}(),function(){$("a[data-toggle=\"tab\"]").on("shown.bs.tab",a=>{if(b)return;let c=a.target,d=c.getAttribute("data-cookie-name"),e=c.getAttribute("data-cookie-value");null===d||""===d||(createCookie(d,e),document.querySelectorAll("a[data-toggle=\"tab\"]").forEach(a=>{d===a.getAttribute("data-cookie-name")&&e===a.getAttribute("data-cookie-value")&&(b=!0,$(".nav-tabs a[href=\""+a.hash+"\"]").tab("show"),b=!1)}))})}(),function(){$("[data-toggle=popover]").popover()}(),handlePageScroll()}function handlePageScroll(){function a(){scrollToTopButton&&(300<document.body.scrollTop||300<document.documentElement.scrollTop?scrollToTopButton.style.display="block":scrollToTopButton.style.display="none")}function b(){if(tocLinks){let a=-1,b=1e6,c=-1,d=-1e6;for(let e=0;e<tocLinks.length;e++){const f=tocHeadings[e];if(null===f)continue;const g=f.getBoundingClientRect();(g.width||g.height)&&(0<=g.top&&g.top<window.innerHeight?g.top<b&&(a=e,b=g.top):0>g.top&&g.top>d&&(c=e,d=g.top)),tocLinks[e].classList.remove("current")}0<=a?tocLinks[a].classList.add("current"):0<=c&&tocLinks[c].classList.add("current")}}a(),b()}document.addEventListener("DOMContentLoaded",handleDOMLoaded),window.addEventListener("scroll",handlePageScroll);
