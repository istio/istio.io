...
"use strict";class KbdNav{constructor(a){this.elements=a}focusFirstElement(){this.elements[0].focus()}focusLastElement(){this.elements[this.elements.length-1].focus()}focusNextElement(){for(let a=0;a<this.elements.length;a++)if(this.elements[a]===document.activeElement){if(a<this.elements.length-1)return void this.elements[a+1].focus();break}this.focusFirstElement()}focusPrevElement(){for(let a=0;a<this.elements.length;a++)if(this.elements[a]===document.activeElement){if(0<a)return void this.elements[a-1].focus();break}this.focusLastElement()}focusElementByChar(a){function b(a,b){for(let c=a;c<this.elements.length;c++){const a=this.elements[c].textContent.trim().substring(0,1).toLowerCase();if(b===a)return c}return-1}a=a.toLowerCase();for(let c=0;c<this.elements.length;c++)if(this.elements[c]===document.activeElement){let d=b(c+1,a);-1===d&&(d=b(0,a)),-1<d&&this.elements[d].focus();break}}}
