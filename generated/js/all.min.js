...
"use strict";const keyCodes=Object.freeze({DOWN:40,END:35,ESC:27,HOME:36,LEFT:37,PAGEDOWN:34,PAGEUP:33,RETURN:13,RIGHT:39,SPACE:32,TAB:9,UP:38}),escapeChars={'"':"#39","&":"amp","'":"quot","<":"lt",">":"gt","¢":"cent","£":"pound","¥":"yen","©":"copy","®":"reg","€":"euro"},regex=/[¢£¥€©®<>"&']/g;function escapeHTML(a){return a.replace(regex,a=>"&"+escapeChars[a]+";")}function copyToClipboard(a){const b=document.getSelection();if(b){const c=document.createElement("textarea");if(c.value=a,c.setAttribute("readonly",""),c.style.position="absolute",c.style.left="-9999px",document.body.appendChild(c),0<b.rangeCount){const a=b.getRangeAt(0);c.select(),document.execCommand("copy"),document.body.removeChild(c),b.removeAllRanges(),b.addRange(a)}}}function saveFile(a,b){const c=document.createElement("a");c.setAttribute("href","data:text/text;charset=utf-8,"+encodeURI(b)),c.setAttribute("download",a),c.click()}function printText(a){const b=window.open("","","left=0,top=0,width=100,height=100,toolbar=0,scrollbars=0,status=0,location=0,menubar=0",!1);b&&(b.document.write("<html><body><pre><code>"+a+"</code></pre></html>"),b.document.close(),b.focus(),b.print(),b.close())}function navigateToUrlOrRoot(a){const b=new XMLHttpRequest;b.open("GET",a,!0),b.onreadystatechange=()=>{if(4===b.readyState&&404===b.status){const b=new URL(a);b.pathname="",a=b.toString()}window.location.href=a},b.send()}function createCookie(a,b){document.cookie=a+"="+b+"; path=/"}function getById(a){return document.getElementById(a)}function listen(a,b,c){a&&a.addEventListener(b,c)}function toggleAttribute(a,b){"true"===a.getAttribute(b)?a.setAttribute(b,"false"):a.setAttribute(b,"true")}function isPrintableCharacter(a){return 1===a.length&&null!=a.match(/\S/)}
