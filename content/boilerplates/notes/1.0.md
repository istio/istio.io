...
- **Istio Ingress Deprecated**. The old Istio ingress is deprecated and disabled by default. We encourage users to use [gateways](/docs/concepts/traffic-management/routing/gateways/) instead.
...
coupled with client-side [destination rules](/docs/concepts/traffic-management/routing/destination-rules/).
