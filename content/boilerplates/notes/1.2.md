...
- **Fixed** [SAN](https://tools.ietf.org/html/rfc5280#section-4.2.1.6) field in workload certificates is set as `critical`. This is required because the Istio workload certificates have empty `subject` fields.
