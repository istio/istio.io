...
- **Added** support for configuring the secret paths via `global.sds.customTokenDirectory` for Istio mutual TLS certificates. Refer [here](https://github.com/istio/istio/issues/11984) for more details.
