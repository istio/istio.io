...
other source identifier. We call this property of the egress control system _being Kubernetes-aware_: the system must
...
accessed, all other egress traffic must be blocked. The rationale for this requirement is that you want to prevent
