...
For this task I set up an instance of [MySQL](https://www.mysql.com). You can use any MySQL instance; I use [Compose for MySQL](https://www.ibm.com/cloud/compose/mysql). I use `mysqlsh` ([MySQL Shell](https://dev.mysql.com/doc/mysql-shell/en/)) as a MySQL client to feed the ratings data.
...
The example commands in this blog post work with Istio 0.3+, with or without [Mutual TLS](/docs/concepts/security/#authentication) enabled.
...
[mutual TLS authentication](/docs/concepts/security/#authentication). There is no need to create an egress rule to access this service; however, the
