...
Next, [install Helm](https://docs.helm.sh/using_helm/) and [generate a minimal Istio install](/docs/setup/kubernetes/install/helm/) -- only traffic management components:
