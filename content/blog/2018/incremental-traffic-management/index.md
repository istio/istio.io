...
Next, [install Helm](https://helm.sh/docs/using_helm/) and [generate a minimal Istio install](/docs/setup/kubernetes/install/helm/) -- only traffic management components:
