...
1.  If using [Google Kubernetes Engine](/docs/setup/kubernetes/prepare/platform-setup/gke/), make sure `bigquery` [Scope](https://cloud.google.com/sdk/gcloud/reference/container/clusters/create) is enabled on the cluster.
...
1.  If using [Google Kubernetes Engine](/docs/setup/kubernetes/prepare/platform-setup/gke/), make sure `pubsub` [Scope](https://cloud.google.com/sdk/gcloud/reference/container/clusters/create) is enabled on the cluster.
