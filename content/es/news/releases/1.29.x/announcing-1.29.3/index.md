---
title: Anuncio de Istio 1.29.3
linktitle: 1.29.3
subtitle: Versión de Parche
description: Parche de Istio 1.29.3.
...
Esta versión contiene correcciones de errores para mejorar la robustez. Estas notas de versión describen las diferencias entre Istio 1.29.2 e Istio 1.29.3.
...
- **Corregido** un deadlock en el controlador de secrets multi-clúster que podía ocurrir durante las actualizaciones de clústeres remotos.
  ([Issue #59875](https://github.com/istio/istio/issues/59875))

- **Corregido** un bypass de autorización en la coincidencia de `AuthorizationPolicy` para identidades SPIFFE y namespaces. Los metacaracteres de expresiones regulares en campos como `source.principals` (coincidencia de sufijo) y `source.namespaces` no se escapaban correctamente en la configuración generada de Envoy, lo que podía permitir que identidades no previstas coincidieran con las reglas de políticas.
