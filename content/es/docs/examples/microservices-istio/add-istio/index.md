...
1.  Redeploy the `productpage` microservice, Istio-enabled:
    ...
    [Automatic sidecar injection](/es/docs/setup/additional-setup/sidecar-injection/#automatic-sidecar-injection) is the recommended method for production use.
    {{< /tip >}}
...
You are ready to
[enable Istio on all the microservices](/es/docs/examples/microservices-istio/enable-istio-all-microservices).
