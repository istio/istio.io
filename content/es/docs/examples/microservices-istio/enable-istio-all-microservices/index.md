...
1.  Access the Istio dashboard using the custom URL you set in your `/etc/hosts` file
    [previously](/es/docs/examples/microservices-istio/bookinfo-kubernetes/#update-your-etc-hosts-configuration-file):
...
1.  Visualize your application's topology by using the
    ...
    If you installed Kiali as part of the [getting started](/es/docs/setup/getting-started/) instructions, your Kiali console user name is `admin` and the password is `admin`.
...
You are ready to
[configure the Istio Ingress Gateway](/es/docs/examples/microservices-istio/istio-ingress-gateway).
