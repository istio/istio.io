...
El {{< gloss >}}data plane{{< /gloss >}} es el conjunto de proxies que median y controlan toda la comunicación de red entre microservices. También recopilan y reportan telemetría sobre todo el tráfico de la malla.
...
Los usuarios a menudo despliegan una malla para habilitar una postura de seguridad zero-trust como primer paso y luego habilitan selectivamente capacidades L7 según sea necesario. La malla ambient permite a esos usuarios evitar completamente el costo del procesamiento L7 cuando no es necesario.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <th>Agregar workloads a la malla</th>
    ...
    <tr>
      <th>Pod de aplicación comprometido<br>da acceso a claves de la malla</th>
      <td>Sí</td>
      <td>No</td>
    </tr>
    <tr>
...
El sobrecosto para procesar protocolos en capa 7 es significativamente mayor que el procesamiento de paquetes en capa 4. Para un servicio dado, si tus requisitos pueden ser satisfechos en L4, la malla de servicio puede ser entregada a un costo sustancialmente menor.
