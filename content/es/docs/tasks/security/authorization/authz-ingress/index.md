...
* Install Istio using the [Istio installation guide](/es/docs/setup/install/istioctl/).
...
[Determining the ingress IP and ports](/es/docs/tasks/traffic-management/ingress/ingress-control/#determining-the-ingress-ip-and-ports)
