...
los workloads aún pueden recibir tráfico de texto plano. Para evitar el tráfico no mTLS para toda el mesh,
...
Dado que no especifica un valor para el campo `selector`, la política se aplica a todos los workloads de el mesh.
