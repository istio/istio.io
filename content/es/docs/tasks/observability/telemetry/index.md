...
Un recurso de la API de Telemetría en el namespace de configuración raíz, típicamente `istio-system`, proporciona valores predeterminados para el comportamiento de toda el mesh.
...
recursos de la API de Telemetría de toda el mesh en el namespace de configuración raíz.

Las anulaciones específicas del namespace para la configuración de toda el mesh se pueden lograr aplicando un nuevo recurso `Telemetry` en el namespace deseado
...
### Configuración del comportamiento de toda el mesh
...
el comportamiento de toda el mesh, agregue un nuevo (o edite el existente) recurso `Telemetry` en el namespace de configuración raíz.
...
Esta configuración anula el proveedor predeterminado de `MeshConfig`, estableciendo el valor predeterminado de el mesh en el proveedor `localtrace`.
También establece el porcentaje de muestreo de toda el mesh en `100`, y configura una etiqueta para que se agregue a todos los spans de traza con
...
Cuando se despliega en un mesh con la configuración de ejemplo de toda el mesh anterior, esto dará como resultado
