...
description: Esta tarea muestra cómo configurar y usar el Dashboard de Istio para monitorear el tráfico de el mesh.
weight: 40
...
tráfico de el mesh. Como parte de esta tarea, utilizará el addon de Grafana Istio y
...
1.  Envíe tráfico a el mesh.
    ...
    Esto proporciona una vista global de el mesh junto con los services y workloads en el mesh.
...
1. Una Vista de Resumen de el mesh. Esta sección proporciona una vista de Resumen Global de el mesh y muestra los workloads HTTP/gRPC y TCP
   en el mesh.

1. Vista de Services Individuales. Esta sección proporciona métricas sobre solicitudes y
   respuestas para cada service individual dentro de el mesh (HTTP/gRPC y TCP).
...
1. Vista de Workloads Individuales: Esta sección proporciona métricas sobre solicitudes y
   respuestas para cada workload individual dentro de el mesh (HTTP/gRPC y TCP).
