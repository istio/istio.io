...
configuración de el mesh global a las anotaciones del pod junto con la personalización específica del
...
para anular cualquier configuración de trazado de toda el mesh.
...
tráfico en el mesh y la cantidad de datos de trazado que desea recopilar.
...
durante la configuración de el mesh o cambiar la variable de entorno `PILOT_TRACE_SAMPLE`
