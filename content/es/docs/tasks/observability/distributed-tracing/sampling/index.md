...
El muestreo se puede configurar en varios ámbitos: en toda el mesh, en el namespace o en el workload, lo que ofrece una gran flexibilidad.
...
para anular cualquier configuración de muestreo de toda el mesh.

Por ejemplo, para anular el muestreo de toda el mesh anterior, agregaría lo siguiente a su manifiesto de pod:
