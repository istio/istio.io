...
The [Control Ingress Traffic task](/es/docs/tasks/traffic-management/ingress/ingress-control)
...
Finally, follow [these instructions](/es/docs/tasks/traffic-management/ingress/ingress-control/#determining-the-ingress-ip-and-ports)
...
Istio supports reading a few different Secret formats, to support integration with various tools such as [cert-manager](/es/docs/ops/integrations/certmanager/):
...
See [configuring SNI routing](/es/docs/ops/common-problems/network-issues/#configuring-sni-routing-when-not-sending-sni) for details.
