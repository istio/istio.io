...
[before you begin](/es/docs/tasks/traffic-management/locality-load-balancing/before-you-begin).
...
- [Outlier detection](/es/docs/reference/config/networking/destination-rule/#OutlierDetection)
...
- [Failover](/es/docs/reference/config/networking/destination-rule/#LocalityLoadBalancerSetting-Failover)
  policy between regions. This ensures that failover beyond a region boundary
  will behave predictably.

- [Connection Pool](/es/docs/reference/config/networking/destination-rule/#ConnectionPoolSettings-http)
...
[Cleanup](/es/docs/tasks/traffic-management/locality-load-balancing/cleanup)
