...
description: Describe cómo configurar Istio para enrutar el tráfico de services en el mesh a services externos.
weight: 10
aliases:
...
1. Permitir que el proxy Envoy pase las solicitudes a services que no están configurados dentro de el mesh.
...
una entrada de service definida dentro de el mesh.
...
1.  Cree una `ServiceEntry` para permitir el acceso a un service HTTP externo.
    ...
    o un sitio legítimo, prohibido por las políticas de seguridad de el mesh.
...
1. Usar una entrada de service para registrar un service externo accesible dentro de el mesh. Este es el
   enfoque recomendado.
...
desconocidos dentro de el mesh. Al usar este enfoque,
