...
Istio para permitir el acceso a services HTTP y HTTPS externos desde applications dentro de el mesh.
...
Un ingress gateway le permite definir puntos de entrada a el mesh por los que fluye todo el tráfico entrante.
Un egress gateway es un concepto simétrico; define puntos de salida de el mesh. Los egress gateways permiten
aplicar features de Istio, por ejemplo, monitoreo y reglas de ruta, al tráfico que sale de el mesh.
...
seguros que el resto de el mesh.
...
El administrador del cluster o el proveedor de la nube deben asegurarse de que ningún tráfico salga de el mesh sin pasar por el egress
