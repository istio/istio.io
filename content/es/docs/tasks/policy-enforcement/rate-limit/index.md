...
hasta 4 solicitudes por minuto, permitiendo cualquier tráfico dentro de el mesh.
...
utiliza un service de limitación de tasa gRPC global para proporcionar limitación de tasa para toda el mesh.
