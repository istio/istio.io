...
- [The `IstioOperator` API](/es/docs/reference/config/istio.operator.v1alpha1/)
...
[Customize Istio settings using the Helm API](/es/docs/setup/additional-setup/customize-installation/#customize-istio-settings-using-the-helm-api), below.

If you want to set Kubernetes resource settings, use the `IstioOperator` API as described in
 [Customize Kubernetes settings](/es/docs/setup/additional-setup/customize-installation/#customize-kubernetes-settings).
{{< /tip >}}
...
Each component has a [`KubernetesResourceSpec`](/es/docs/reference/config/istio.operator.v1alpha1/#KubernetesResourcesSpec),
...
[`IstioOperator` API](/es/docs/reference/config/istio.operator.v1alpha1/), gateways are defined as a list type.
...
through the `IstioOperator` [overlays](/es/docs/reference/config/istio.operator.v1alpha1/#K8sObjectOverlay) API, after it is
