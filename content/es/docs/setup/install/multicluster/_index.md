...
- [Network topologies](/es/docs/ops/deployment/deployment-models#network-models):
  one or two networks

- [Control plane topologies](/es/docs/ops/deployment/deployment-models#control-plane-models):
