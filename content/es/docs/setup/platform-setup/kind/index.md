...
- Increase Docker's [memory limit](/es/docs/setup/platform-setup/docker/).
...
1.  If you run multiple clusters, you need to choose which cluster `kubectl` talks to. You can set a default cluster
    ...
    Once you are done setting up a kind cluster, you can proceed to [install Istio](/es/docs/setup/additional-setup/download-istio-release/)
    on it.
