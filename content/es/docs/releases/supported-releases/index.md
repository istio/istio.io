...
The Istio control plane can be one version ahead of the data plane. However, the data plane cannot be ahead of control plane. We recommend using [revisions](/es/docs/setup/upgrade/canary/) so that there is no skew at all.
