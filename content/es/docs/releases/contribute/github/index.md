...
- [Add](/es/docs/releases/contribute/add-content) new files to the repository.
- [Edit](#quick-edit) existing files.
- [Review](/es/docs/releases/contribute/review) the added or modified files.
...
Please see our guides on how to [contribute new content](/es/docs/releases/contribute/add-content)
or [review content](/es/docs/releases/contribute/review) to learn more about submitting more
substantial changes.
...
- The [public site](/es/docs/) shows the content from the current
  release branch.
