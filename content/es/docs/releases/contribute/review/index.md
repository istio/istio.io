...
all changes to the [Istio website](/es/docs/).
...
- Consistency: Content adheres to all recommendations in the
  [Istio contribution guides](/es/docs/releases/contribute/)
- Style: Content adheres to the [Google developer style guide](https://developers.google.com/style).
- Graphic assets: Diagrams follow the Istio [diagram creation guide](/es/docs/releases/contribute/diagrams/).\
