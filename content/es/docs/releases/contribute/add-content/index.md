...
1. Write your contribution following our [documentation contribution guides](/es/docs/releases/contribute).
1. Submit your contribution to our [GitHub repository](https://github.com/istio/istio.io).
1. Follow our [review process](/es/docs/releases/contribute/review) until your contribution
   is merged.
...
If you are not familiar with GitHub, see our [working with GitHub guide](/es/docs/releases/contribute/github)
...
see the [section on branching](/es/docs/releases/contribute/github#branching-strategy) to understand
