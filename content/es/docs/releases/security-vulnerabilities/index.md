...
our [Reporting Bugs](/es/docs/releases/bugs/) page to learn what to do.
...
Istio offers two sets of docker images, based on `ubuntu` (default) and based on `distroless` (see [Harden Docker Container Images](/es/docs/ops/configuration/security/harden-docker-images/)).
...
The [`distroless`](/es/docs/ops/configuration/security/harden-docker-images/) base images are strongly encouraged if reducing base image CVEs is important to you.
