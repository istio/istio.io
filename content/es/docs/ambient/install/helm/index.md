...
configura los proxies para enrutar el tráfico dentro de el mesh.
...
El chart `cni` instala el agente de nodo CNI de Istio. Es responsable de detectar los pods que pertenecen a el mesh ambient y de configurar la redirección del tráfico entre los pods y el proxy de nodo ztunnel (que se instalará más adelante).
...
[agregar tu aplicación a el mesh ambient](/es/docs/ambient/getting-started/secure-and-visualize/#add-bookinfo-to-the-mesh).
