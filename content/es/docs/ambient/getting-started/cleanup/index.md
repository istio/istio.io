...
La etiqueta que indica a Istio que incluya automáticamente las aplicaciones enel namespace `default` en el mesh ambient no se elimina al desinstalar Istio. Utiliza el siguiente comando para eliminarla:
