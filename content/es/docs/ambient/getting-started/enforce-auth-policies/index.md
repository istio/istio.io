...
description: Aplicar políticas de autorización de Layer 4 y Layer 7 en una malla ambient.
weight: 4
owner: istio/wg-networking-maintainers
test: yes
---

Después de haber agregado tu aplicación a la malla ambient, puedes proteger el acceso a la aplicación utilizando políticas de autorización de Layer 4.
...
## Aplicar la política de autorización de Layer 4
...
## Aplicar la política de autorización de Layer 7

Para aplicar las políticas de Layer 7, primero necesitas un {{< gloss "waypoint" >}}waypoint proxy{{< /gloss >}} para el namespaces. Este proxy manejará todo el tráfico de Layer 7 que ingrese al namespaces.
...
{{< tip >}}
Para obtener más información sobre cómo habilitar más características de Istio, lee la [guía de usuario de características de Layer 7](/es/docs/ambient/usage/l7-features/).
{{< /tip >}}
...
Con el proxy de waypoint en su lugar, ahora puedes aplicar políticas de Layer 7 en el namespaces. Además de las políticas de autorización, [puedes usar el proxy de waypoint para dividir el tráfico entre servicios](../manage-traffic/). Esto es útil al realizar despliegues canary o pruebas A/B.
