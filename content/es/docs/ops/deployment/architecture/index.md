...
You can use Istio's
[Traffic Management API](/es/docs/concepts/traffic-management/#introducing-istio-traffic-management)
...
Istiod [security](/es/docs/concepts/security/) enables strong service-to-service and
...
on relatively unstable layer 3 or capa 4 network identifiers.
Additionally, you can use [Istio's authorization feature](/es/docs/concepts/security/#authorization)
