...
[Traffic management rules](/es/docs/ops/configuration/traffic-management/multicluster)
...
[Address auto allocation](/es/docs/ops/configuration/traffic-management/dns-proxy/#address-auto-allocation)
feature of [Istio DNS Proxying](/es/docs/ops/configuration/traffic-management/dns-proxy/).
...
other through one or more [Istio gateways](/es/docs/concepts/traffic-management/#gateways).
...
desirable to use [locality load balancing](/es/docs/tasks/traffic-management/locality-load-balancing)
