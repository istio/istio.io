...
See [Route rules have no effect on ingress gateway requests](/es/docs/ops/common-problems/network-issues/#route-rules-have-no-effect-on-ingress-gateway-requests)
for details.
