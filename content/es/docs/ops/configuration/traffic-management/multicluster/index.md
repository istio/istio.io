...
1. Read [Deployment Models](/es/docs/ops/deployment/deployment-models/#multiple-clusters)
...
using [`MeshConfig.serviceSettings`](/es/docs/reference/config/istio.mesh.v1alpha1/#MeshConfig-ServiceSettings-Settings).
...
[`DestinationRule.subsets`](/es/docs/reference/config/networking/destination-rule/#Subset) allows partitioning a service
by selecting labels. These labels can be the labels from Kubernetes metadata, or from [built-in labels](/es/docs/reference/config/labels/).
...
Using these subsets you can create various routing rules based on the cluster such as [mirroring](/es/docs/tasks/traffic-management/mirroring/)
or [shifting](/es/docs/tasks/traffic-management/traffic-shifting/).
...
[`MeshConfig.serviceSettings`](/es/docs/reference/config/istio.mesh.v1alpha1/#MeshConfig-ServiceSettings-Settings),
