...
See the [platform setup instructions](/es/docs/setup/platform-setup/)
...
1. Verify you’re using a [supported version](/es/docs/releases/supported-releases#support-status-of-istio-releases) ({{< supported_kubernetes_versions >}}) of
...
1. Verify `MutatingAdmissionWebhook` and `ValidatingAdmissionWebhook` plugins are
   ...
   to this flag is [provider specific](/es/docs/setup/platform-setup/).
