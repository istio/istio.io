...
See [`ProxyConfig.Tracing`](/es/docs/reference/config/istio.mesh.v1alpha1/#Tracing) for advanced configuration such as TLS settings.

## Usage

For information on using SkyWalking, please refer to the [SkyWalking task](/es/docs/tasks/observability/distributed-tracing/skywalking/).
