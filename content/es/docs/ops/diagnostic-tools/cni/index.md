...
Before reading this, you should read the [CNI installation and operation guide](/es/docs/setup/additional-setup/cni/).
...
and [race condition repairing](/es/docs/setup/additional-setup/cni/#race-condition--mitigation).

## Monitoring

The CNI DaemonSet [generates metrics](/es/docs/reference/commands/install-cni/#metrics),
...
By default, the Istio CNI DaemonSet has [race condition mitigation](/es/docs/setup/additional-setup/cni/#race-condition--mitigation) enabled,
