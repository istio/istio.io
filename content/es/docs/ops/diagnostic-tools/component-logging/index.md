...
Pilot-Agent, Pilot-Discovery, and the Istio Operator have their own scopes which you can discover by looking at their [reference documentation](/es/docs/reference/commands/).
...
by using its [ControlZ](/es/docs/ops/diagnostic-tools/controlz) interface.
