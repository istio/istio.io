...
This message occurs when the port doesn't follow the [Istio service port naming convention](/es/docs/ops/configuration/traffic-management/protocol-selection/)
...
- If you don't know the protocol the service port is serving, you need to [query metrics from Prometheus](/es/docs/tasks/observability/metrics/querying-metrics/)
