...
If your webhook configurations have no URLs defined, adding valid URLs that use a hostname will resolve this warning message. Instructions on how to do that can be found [here](/es/docs/setup/install/external-controlplane/#set-up-the-remote-config-cluster).
