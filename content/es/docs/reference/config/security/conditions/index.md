...
in the `when` field of an [authorization policy rule](/es/docs/reference/config/security/authorization-policy/#Rule).

For more information, refer to the [authorization concept page](/es/docs/concepts/security/#authorization).
