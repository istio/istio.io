...
For more information, please refer to [authorization normalization best practices](/es/docs/ops/best-practices/security/#customize-your-system-on-path-normalization).

## Path Related

This applies to the [`paths` field](/es/docs/reference/config/security/authorization-policy/#Operation-paths) and the [`notPaths` field](/es/docs/reference/config/security/authorization-policy/#Operation-not_paths).
