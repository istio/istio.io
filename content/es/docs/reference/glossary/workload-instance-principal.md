...
The verifiable authority under which a [workload instance](/es/docs/reference/glossary/#workload-instance) runs.
...
using the `source.principal` and `destination.principal` [attributes](/es/docs/reference/glossary/#attribute).
