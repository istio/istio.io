...
* Deshabilitar la reserva del encabezado del host.
  ...
  En este caso, siga la guía de [personalización de métricas](/es/docs/tasks/observability/metrics/customize-metrics/) para deshabilitar la reserva del encabezado del host en toda el mesh.
