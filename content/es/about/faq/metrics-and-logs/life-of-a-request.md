...
Además, puede usar los siguientes comandos para saber más sobre el estado de el mesh:
...
* `kubectl get`: obtiene información sobre diferentes recursos en el mesh junto con la configuración de enrutamiento:
