...
* **Faltan etiquetas para el tráfico fuera de el mesh**
  ...
  lo que implica que a la telemetría informada cuando un par no está en el mesh le faltarán
  ...
  Cuando el workload del servidor está fuera de el mesh, los metadatos de el workload del servidor todavía
