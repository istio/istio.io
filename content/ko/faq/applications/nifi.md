...
* [`nifi.remote.input.host`](https://nifi.apache.org/ko/docs/nifi-docs/html/administration-guide.html#site_to_site_properties) -
...
* [`nifi.web.https.host`](https://nifi.apache.org/ko/docs/nifi-docs/html/administration-guide.html#web-properties) - The HTTPS host.
...
* [`nifi.cluster.node.address`](https://nifi.apache.org/ko/docs/nifi-docs/html/administration-guide.html#cluster_node_properties) - The
...
* Unless you're okay with all of your users having all access roles in your NiFi deployment, HTTP is not a viable solution as [NiFi does not
  perform user authentication over HTTP](https://nifi.apache.org/ko/docs/nifi-docs/html/administration-guide.html#user_authentication).
