...
* **Missing labels for out-of-mesh traffic**
  ...
  [here](/ko/docs/tasks/observability/metrics/tcp-metrics/#understanding-tcp-telemetry-collection).
  ...
  [here](/ko/docs/reference/config/metrics/) are available in the generated metrics.

* **TCP metadata exchange requires mTLS**
  TCP metadata exchange relies on the [Istio ALPN protocol](/ko/docs/tasks/observability/metrics/tcp-metrics/#understanding-tcp-telemetry-collection)
