...
You can modify a [generated manifest](/ko/docs/setup/install/istioctl/#generate-a-manifest-before-installation)
...
After [setting up the machines](/ko/docs/examples/virtual-machines/single-network/#setting-up-the-vm) for Istio
