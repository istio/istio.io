...
The [Stackdriver tracing integration](https://cloud.google.com/istio/ko/docs/istio-on-gke/installing#tracing_and_logging) with Istio is one example of a tracing integration via Mixer.
