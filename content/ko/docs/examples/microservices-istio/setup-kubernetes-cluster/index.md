...
proceed to [setting up your local computer](/ko/docs/examples/microservices-istio/setup-local-computer).
{{</ warning >}}

1.  Ensure you have access to a
    [Kubernetes cluster](https://kubernetes.io/ko/docs/tutorials/kubernetes-basics/).
    You can use the
    [Google Kubernetes Engine](https://cloud.google.com/kubernetes-engine/ko/docs/quickstart)
    or the
    [IBM Cloud Kubernetes Service](https://cloud.ibm.com/ko/docs/containers?topic=containers-getting-started).
...
1.  [Install Istio](/ko/docs/setup/getting-started/) using the `demo` profile.

1.  The [Kiali](/ko/docs/ops/integrations/kiali/) and [Prometheus](/ko/docs/ops/integrations/prometheus/) addons are used in this example and need to be installed. All addons are installed using:
...
1.  Next, enable Envoy's access logging as described in
    [Enable Envoy's access logging](/ko/docs/tasks/observability/logs/access-log/#before-you-begin).
...
1.  Create a Kubernetes Ingress resource for these common Istio services using
    ...
    - [Grafana](https://grafana.com/ko/docs/guides/getting_started/)
    - [Jaeger](https://www.jaegertracing.io/ko/docs/1.13/getting-started/)
    - [Prometheus](https://prometheus.io/ko/docs/prometheus/latest/getting_started/)
...
You are ready to [setup a local computer](/ko/docs/examples/microservices-istio/setup-local-computer).
