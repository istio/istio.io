...
[Bookinfo example](/ko/docs/examples/bookinfo) page.

The [Bookinfo example](/ko/docs/examples/bookinfo) shows the final state of the application, in which the `reviews` microservice has three versions: `v1`, `v2`, `v3`. In this module, the application only uses the `v1` version of the
...
You are ready to [test the application](/ko/docs/examples/microservices-istio/production-testing).
