...
1.  Set `INGRESS_HOST` and `INGRESS_PORT` using the instructions in the
    [Determining the Ingress IP and ports](/ko/docs/tasks/traffic-management/ingress/ingress-control/#determining-the-ingress-ip-and-ports) section.
...
You are ready to configure [logging with Istio](/ko/docs/examples/microservices-istio/logs-istio).
