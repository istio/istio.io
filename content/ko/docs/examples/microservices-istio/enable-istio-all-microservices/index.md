...
1.  Visualize your application's topology by using the
    ...
    If you installed Kiali as part of the [getting started](/ko/docs/setup/getting-started/) instructions, your Kiali console user name is `admin` and the password is `admin`.
...
You are ready to
[configure the Istio Ingress Gateway](/ko/docs/examples/microservices-istio/istio-ingress-gateway).
