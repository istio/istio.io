...
1.  Install [`kubectl`](https://kubernetes.io/ko/docs/tasks/tools/install-kubectl/).
...
You are ready to [run a single service locally](/ko/docs/examples/microservices-istio/single/).
