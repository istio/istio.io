...
- Setup Istio by following the instructions in the
  [Installation guide](/ko/docs/setup/getting-started/).

- Deploy the [Bookinfo](/ko/docs/examples/bookinfo/) sample application (in the `bookinfo` namespace).

- Create a VM named 'vm-1' in the same project as the Istio cluster, and [join the mesh](/ko/docs/examples/virtual-machines/single-network/).
...
On a host with access to [`istioctl`](/ko/docs/reference/commands/istioctl) commands, register the VM and mysql db service
