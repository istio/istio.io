...
[architecture overview](/ko/docs/ops/deployment/architecture/). The rest of
...
[Virtual services](/ko/docs/reference/config/networking/virtual-service/#VirtualService),
...
-   Configure traffic rules in combination with
    [gateways](/ko/docs/concepts/traffic-management/#gateways) to control ingress
    and egress traffic.
...
[TCP](/ko/docs/reference/config/networking/virtual-service/#TCPRoute) and
unterminated
[TLS](/ko/docs/reference/config/networking/virtual-service/#TLSRoute)
...
[`HTTPMatchRequest` reference](/ko/docs/reference/config/networking/virtual-service/#HTTPMatchRequest).
...
[`HTTPRoute` reference](/ko/docs/reference/config/networking/virtual-service/#HTTPRoute).

## Destination rules {#destination-rules}

Along with [virtual services](#virtual-services),
[destination rules](/ko/docs/reference/config/networking/destination-rule/#DestinationRule)
...
[Destination Rule reference](/ko/docs/reference/config/networking/destination-rule/).
...
See the
[Envoy load balancing documentation](https://www.envoyproxy.io/ko/docs/envoy/v1.5.0/intro/arch_overview/load_balancing)
...
You use a [gateway](/ko/docs/reference/config/networking/gateway/#Gateway) to
...
deployed if you use our [demo installation](/ko/docs/setup/getting-started/),
while just the ingress gateway is deployed with our
[default profile.](/ko/docs/setup/additional-setup/config-profiles/) You
...
You use a
[service entry](/ko/docs/reference/config/networking/service-entry/#ServiceEntry) to add
...
-   Run a mesh service in a Virtual Machine (VM) by
    [adding VMs to your mesh](/ko/docs/examples/virtual-machines/).
-   Logically add services from a different cluster to the mesh to configure a
    [multicluster Istio mesh](/ko/docs/setup/install/multicluster/gateways/#configure-the-example-services)
    on Kubernetes.
...
See the
[Service Entry reference](/ko/docs/reference/config/networking/service-entry)
...
forwarding traffic. You can use a [sidecar](/ko/docs/reference/config/networking/sidecar/#Sidecar) configuration to do the following:
...
See the [Sidecar reference](/ko/docs/reference/config/networking/sidecar/)
for more details.
...
[Circuit Breaking](/ko/docs/tasks/traffic-management/circuit-breaking/).
