...
Visit our
[mutual TLS Migration docs](/ko/docs/tasks/security/authentication/mtls-migration/)
to start using Istio security features with your deployed services. Visit our
[Security Tasks](/ko/docs/tasks/security/) for detailed
...
- The configuration API server distributes to the proxies:
    ...
    - [authentication policies](/ko/docs/concepts/security/#authentication-policies)
    - [authorization policies](/ko/docs/concepts/security/#authorization-policies)
    - [secure naming information](/ko/docs/concepts/security/#secure-naming)
...
[secure naming](/ko/docs/concepts/security/#secure-naming)
...
[secret discovery service (SDS)](https://www.envoyproxy.io/ko/docs/envoy/latest/configuration/security/secret#secret-discovery-service-sds)
...
- Request authentication: Used for end-user authentication to verify the
   ...
   Connect providers, for example:
    ...
    - [Firebase Auth](https://firebase.google.com/ko/docs/auth/)
...
[Mutual TLS Migration tutorial](/ko/docs/tasks/security/authentication/mtls-migration).
...
TLS mode with
[destination rules](/ko/docs/concepts/traffic-management/#destination-rules).
You can find out more about how mutual TLS works in the
[Mutual TLS authentication section](/ko/docs/concepts/security/#mutual-tls-authentication).
...
[authorization](/ko/docs/concepts/security/#authorization).

### Authentication policies

This section provides more details about how Istio authentication policies work.
As you'll remember from the
[Architecture section](/ko/docs/concepts/security/#authentication-architecture),
...
[TLS settings reference docs](/ko/docs/reference/config/networking/destination-rule#ClientTLSSettings).
...
- A Simple API: it includes a single
  [`AuthorizationPolicy` CRD](/ko/docs/reference/config/security/authorization-policy/),
...
[`AuthorizationPolicy` custom resource](/ko/docs/reference/config/security/authorization-policy/).
...
[conditions page](/ko/docs/reference/config/security/conditions/).
