---
title: 확장 가능성
description: 이스티오의 웹어셈블리 플러그인 시스템을 설명한다.
weight: 50
...
A detailed description of the C++ SDK can be found [here](https://github.com/proxy-wasm/proxy-wasm-cpp-sdk/tree/a30aaeedf30cc1545318505574c7fb3bb8d8c243/ko/docs/wasm_filter.md).
