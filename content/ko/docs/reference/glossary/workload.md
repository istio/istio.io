...
test: n/a
---
A binary deployed by [operators](/ko/docs/reference/glossary/#operator) to deliver some function of a service mesh application.
Workloads have names, namespaces, and unique ids. These properties are available in policy and telemetry configuration
using the following [attributes](/ko/docs/reference/glossary/#attribute):
...
while a [workload instance](/ko/docs/reference/glossary/#workload-instance) corresponds to an individual [pod](/ko/docs/reference/glossary/#pod) managed
by the deployment.
