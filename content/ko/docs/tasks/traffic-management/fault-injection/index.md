---
title: 결함 주입
description: 이 태스크는 애플리케이션의 복원력을 테스트하기 위해 결함을 주입하는 방법을 보여 준다.
weight: 20
...
[Traffic Management](/ko/docs/concepts/traffic-management) concepts doc.

* Apply application version routing by either performing the
  [request routing](/ko/docs/tasks/traffic-management/request-routing/) task or by
...
1. Open the [Bookinfo](/ko/docs/examples/bookinfo) web application in your browser.
...
[traffic shifting](/ko/docs/tasks/traffic-management/traffic-shifting/) task, you can then
