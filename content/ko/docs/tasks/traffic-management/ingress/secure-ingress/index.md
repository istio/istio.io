...
weight: 21
aliases:
    - /ko/docs/tasks/traffic-management/ingress/secure-ingress-sds/
    - /ko/docs/tasks/traffic-management/ingress/secure-ingress-mount/
keywords: [traffic-management,ingress,sds-credentials]
owner: istio/wg-networking-maintainers
test: yes
---

The [Control Ingress Traffic task](/ko/docs/tasks/traffic-management/ingress)
...
1.  Perform the steps in the [Before you begin](/ko/docs/tasks/traffic-management/ingress/ingress-control#before-you-begin).
and [Determining the ingress IP and ports](/ko/docs/tasks/traffic-management/ingress/ingress-control/#determining-the-ingress-ip-and-ports)
sections of the [Control Ingress Traffic](/ko/docs/tasks/traffic-management/ingress/ingress-control) task. After performing
...
1.  Ensure you have deployed the [httpbin]({{< github_tree >}}/samples/httpbin) service from [Before you begin](/ko/docs/tasks/traffic-management/ingress/ingress-control#before-you-begin).
...
Istio supports reading a few different Secret formats, to support integration with various tools such as [cert-manager](/ko/docs/ops/integrations/certmanager/):
