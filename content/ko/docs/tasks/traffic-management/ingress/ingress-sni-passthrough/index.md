...
aliases:
  - /ko/docs/examples/advanced-gateways/ingress-sni-passthrough/
owner: istio/wg-networking-maintainers
test: yes
---

The [Securing Gateways with HTTPS](/ko/docs/tasks/traffic-management/ingress/secure-ingress/) task describes how to configure HTTPS
...
1. Create a Kubernetes [Secret](https://kubernetes.io/ko/docs/concepts/configuration/secret/) to hold the server's
   certificate.
...
1.  Create a Kubernetes [ConfigMap](https://kubernetes.io/ko/docs/tasks/configure-pod-container/configure-pod-configmap/)
