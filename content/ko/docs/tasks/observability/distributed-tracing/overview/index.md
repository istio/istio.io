...
Istio leverages [Envoy's distributed tracing](https://www.envoyproxy.io/ko/docs/envoy/v1.12.0/intro/arch_overview/observability/tracing) feature
...
See [Zipkin](../zipkin/), [Jaeger](../jaeger/) and [Lightstep](/ko/docs/tasks/observability/distributed-tracing/lightstep/) task docs about how Istio works with those tracing systems.
