---
title: 구성 가능성 (베타/개발중)
description: 추적 옵션 구성 방법 (베타/개발중).
weight: 60
...
1.  Ensure that your applications propagate tracing headers as described [here](/ko/docs/tasks/observability/distributed-tracing/overview/).

1.  Follow the tracing installation guide located under [Integrations](/ko/docs/ops/integrations/)
