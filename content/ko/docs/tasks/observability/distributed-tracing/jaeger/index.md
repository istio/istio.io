---
title: 예거
description: 추적 요청을 예거로 보내도록 프록시를 구성하는 방법에 대해 학습한다.
weight: 10
...
1.  Follow the [Jaeger installation](/ko/docs/ops/integrations/jaeger/#installation) documentation to deploy Jaeger into your cluster.
