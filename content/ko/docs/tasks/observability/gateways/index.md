---
title: 텔레메트리 애드온 원격 접근
description: 이 태스크는 이스티오 텔레메트리 애드온 세트에 대한 외부 접근을 구성하는 방법을 보여 준다.
weight: 98
...
1. [Install Istio](/ko/docs/setup/install/istioctl) in your cluster.

    To additionally install the telemetry addons, follow the [integrations](/ko/docs/ops/integrations/) documentation.
