...
[AttributeGen plugin](/ko/docs/reference/config/proxy_extensions/attributegen/) that groups requests
...
[`Open API Spec operationId`](https://swagger.io/ko/docs/specification/paths-and-operations/).
...
[reference content](/ko/docs/reference/config/proxy_extensions/attributegen/).
