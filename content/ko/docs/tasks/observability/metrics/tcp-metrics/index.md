...
aliases:
    - /ko/docs/tasks/telemetry/tcp-metrics
    - /ko/docs/tasks/telemetry/metrics/tcp-metrics/
...
The [Bookinfo](/ko/docs/examples/bookinfo/) sample application is used
as the example throughout this task.

## Before you begin

* [Install Istio](/ko/docs/setup) in your cluster and deploy an
application. You must also install [Prometheus](/ko/docs/ops/integrations/prometheus/).
...
via [`tcpReportingDuration`](/ko/docs/reference/config/proxy_extensions/stats/#PluginConfig).
