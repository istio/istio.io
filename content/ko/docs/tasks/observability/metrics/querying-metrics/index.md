...
aliases:
    - /ko/docs/tasks/telemetry/querying-metrics/
    - /ko/docs/tasks/telemetry/metrics/querying-metrics/
...
* [Install Istio](/ko/docs/setup) in your cluster.
* Install the [Prometheus Addon](/ko/docs/ops/integrations/prometheus/#option-1-quick-start).
* Deploy the [Bookinfo](/ko/docs/examples/bookinfo/) application.
...
docs](https://prometheus.io/ko/docs/querying/basics/).
