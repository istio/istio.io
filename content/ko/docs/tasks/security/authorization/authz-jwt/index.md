...
description: 이스티오에서 JWT로 접근 제어를 설정 방법.
weight: 30
...
* Read [Authorization](/ko/docs/concepts/security/#authorization) and [Authentication](/ko/docs/concepts/security/#authentication).

* Install Istio using [Istio installation guide](/ko/docs/setup/install/istioctl/).
