---
title: HTTP 트래픽 인가
description: HTTP 트래픽에 대한 접근 제어 설정 방법을 보여 준다.
weight: 10
...
Learn more in our [authorization concept page](/ko/docs/concepts/security/#authorization).

## Before you begin

The activities in this task assume that you:

* Read the [authorization concept](/ko/docs/concepts/security/#authorization).

* Follow the [Istio installation guide](/ko/docs/setup/install/istioctl/) to install Istio with mutual TLS enabled.

* Deploy the [Bookinfo](/ko/docs/examples/bookinfo/#deploying-the-application) sample application.
