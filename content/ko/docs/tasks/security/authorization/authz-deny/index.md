---
title: 거부(deny) 인가 정책
description: 트래픽을 명시적으로 거부하도록 접근 제어를 설정하는 방법을 보여 준다.
weight: 40
...
in an Istio mesh. Learn more in our [authorization concept page](/ko/docs/concepts/security/#authorization).
...
* Follow the [Istio installation guide](/ko/docs/setup/install/istioctl/) to install Istio.
