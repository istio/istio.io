---
title: 인그레스 게이트웨이 인가
description: 인그레스 게이트웨이에 접근 제어를 설정하는 방법.
weight: 50
...
* Read the [Authorization conceptual documentation](/ko/docs/concepts/security/#authorization).

* Install Istio using the [Istio installation guide](/ko/docs/setup/install/istioctl/).
...
* See [Source IP for Services with `Type=NodePort`](https://kubernetes.io/ko/docs/tutorials/services/source-ip/#source-ip-for-services-with-type-nodeport)
