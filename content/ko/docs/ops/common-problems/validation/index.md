---
title: 구성 검증 문제
description: 구성 검증 문제 해결 방법을 설명한다.
...
Use [istioctl validate -f](/ko/docs/reference/commands/istioctl/#istioctl-validate) and [istioctl analyze](/ko/docs/reference/commands/istioctl/#istioctl-analyze) for more insight into why the configuration is rejected.  Use an _istioctl_ CLI with a similar version to the control plane version.
...
[Istio API reference](/ko/docs/reference/config) when
necessary.
