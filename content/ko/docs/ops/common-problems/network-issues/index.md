---
title: 트래픽 관리 문제
description: 일반적인 이스티오 트래픽 관리 및 네트워크 문제를 해결하는 기법.
...
Refer to the [Envoy response flags](https://www.envoyproxy.io/ko/docs/envoy/latest/configuration/observability/access_log/usage#config-access-log-format-response-flags)
...
If route rules are working perfectly for the [Bookinfo](/ko/docs/examples/bookinfo/) sample,
...
Refer to the [Requirements for Pods and Services](/ko/docs/ops/deployment/requirements/)
for details.
...
{{< tip >}}
You should only see this error if you disabled [automatic mutual TLS](/ko/docs/tasks/security/authentication/authn-policy/#auto-mutual-tls) during install.
{{< /tip >}}
...
will need to set the [proxy_http_version](https://nginx.org/en/ko/docs/http/ngx_http_proxy_module.html#proxy_http_version) directive in your NGINX configuration to be "1.1", since the NGINX default is 1.0.
