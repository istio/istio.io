---
title: 관측성 모범 사례
description: 이스티오를 사용하여 애플리케이션을 관측하는 모범 사례.
...
is to use [hierarchical federation](https://prometheus.io/ko/docs/prometheus/latest/federation/#hierarchical-federation)
in combination with a collection of [recording rules](https://prometheus.io/ko/docs/prometheus/latest/configuration/recording_rules/).
...
[Istio Standard Metrics](/ko/docs/reference/config/metrics/), including all Istio dimensions. While this
...
[Istio Standard Metrics](/ko/docs/reference/config/metrics/) and renaming any metrics collected by removing
