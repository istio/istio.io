---
title: 보안 모범 사례
description: 이스티오를 사용하여 애플리케이션을 보호하는 모범 사례.
...
[Kubernetes namespace](https://kubernetes.io/ko/docs/tasks/administer-cluster/namespaces-walkthrough/) for each SRE team to isolate their access.
...
control in [Istio Mixer](https://istio.io/v1.6/ko/docs/reference/config/policy-and-telemetry/) such that
...
While most cloud providers support this feature now, many local development tools and custom installations may not. To enable this feature, please refer to the [Kubernetes documentation](https://kubernetes.io/ko/docs/tasks/configure-pod-container/configure-service-account/#service-account-token-volume-projection).
