---
title: 트래픽 관리 모범 사례
description: 네트워킹 또는 트래픽 관리 이슈를 방지하기 위한 구성 모범 사례.
...
See [Route rules have no effect on ingress gateway requests](/ko/docs/ops/common-problems/network-issues/#route-rules-have-no-effect-on-ingress-gateway-requests)
for details.
