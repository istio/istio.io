---
title: 엔보이와 Istiod 디버깅
description: 트래픽 관리와 관련된 엔보이 구성 문제를 진단하기 위한 도구 및 기법을 설명한다.
weight: 20
...
the [`proxy-status`](/ko/docs/reference/commands/istioctl/#istioctl-proxy-status)
and [`proxy-config`](/ko/docs/reference/commands/istioctl/#istioctl-proxy-config) commands. The `proxy-status` command
...
[installation steps](/ko/docs/setup/getting-started/) and
[Bookinfo installation steps](/ko/docs/examples/bookinfo/#deploying-the-application)).
