---
title: istioctl describe 로 메시 이해하기
description: istioctl describe 을 사용하여 메시에 있는 파드 구성을 확인하는 방법을 보여 준다.
weight: 30
...
In Istio 1.3, we included the [`istioctl experimental describe`](/ko/docs/reference/commands/istioctl/#istioctl-experimental-describe-pod)
...
This guide assumes you have deployed the [Bookinfo](/ko/docs/examples/bookinfo/)
sample in your mesh. If you haven't already done so,
[start the application's services](/ko/docs/examples/bookinfo/#start-the-application-services)
and [determine the IP and port of the ingress](/ko/docs/examples/bookinfo/#determine-the-ingress-ip-and-port)
before continuing.
...
if some of the [Istio requirements for pods](/ko/docs/ops/deployment/requirements/)
are not met.
...
[destination rules](/ko/docs/concepts/traffic-management/#destination-rules) apply to requests
...
When [virtual services](/ko/docs/concepts/traffic-management/#virtual-services) configure
...
Following the [mutual TLS migration](/ko/docs/tasks/security/authentication/mtls-migration/)
