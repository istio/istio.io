---
title: 동적 승인 웹훅 개요
description: 이스티오의 쿠버네티스 웹훅 사용 및 발생할 수 있는 관련 이슈에 대한 개요를 제공한다.
weight: 10
owner: istio/wg-user-experience-maintainers
test: no
---

From [Kubernetes mutating and validating webhook mechanisms](https://kubernetes.io/ko/docs/reference/access-authn-authz/extensible-admission-controllers/):
...
Dynamic Admission Webhooks. Consult the [Kubernetes API references](https://kubernetes.io/ko/docs/reference/generated/kubernetes-api/v1.11/) for
...
See the [platform setup instructions](/ko/docs/setup/platform-setup/)
...
1. Verify you’re using a supported version ({{< supported_kubernetes_versions >}}) of
   [`kubectl`](https://kubernetes.io/ko/docs/tasks/tools/install-kubectl/) and of the Kubernetes server:
...
1. Verify `MutatingAdmissionWebhook` and `ValidatingAdmissionWebhook` plugins are
   ...
   to this flag is [provider specific](/ko/docs/setup/platform-setup/).
