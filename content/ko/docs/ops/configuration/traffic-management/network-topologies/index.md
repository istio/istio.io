...
Istio provides the ability to manage settings like [X-Forwarded-For](https://www.envoyproxy.io/ko/docs/envoy/latest/configuration/http/http_conn_man/headers#x-forwarded-for) (XFF)
and [X-Forwarded-Client-Cert](https://www.envoyproxy.io/ko/docs/envoy/latest/configuration/http/http_conn_man/headers#x-forwarded-client-cert)
...
client address. Please refer to the [Envoy documentation](https://www.envoyproxy.io/ko/docs/envoy/latest/configuration/http/http_conn_man/headers#x-forwarded-for)
...
From [Envoy's documentation](https://www.envoyproxy.io/ko/docs/envoy/latest/configuration/http/http_conn_man/headers#x-forwarded-client-cert)
regarding XFCC:
...
See the [Envoy documentation](https://www.envoyproxy.io/ko/docs/envoy/latest/configuration/http/http_conn_man/headers#x-forwarded-client-cert)
