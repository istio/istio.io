...
aliases:
  ...
  - /ko/docs/ops/traffic-management/protocol-selection
...
To enable them, configure the corresponding Pilot [environment variables](/ko/docs/reference/commands/pilot-discovery/#envvars).
