...
aliases:
  ...
  - /ko/docs/ops/traffic-management/locality-load-balancing
...
In Kubernetes, a pod's locality is determined via the [well-known labels for region and zone](https://kubernetes.io/ko/docs/reference/kubernetes-api/labels-annotations-taints/#failure-domainbetakubernetesioregion)
...
To determine when instances are unhealthy, the proxies require an [outlier detection](/ko/docs/reference/config/networking/destination-rule/#OutlierDetection)
...
receiving traffic. You can find the exact percentages in the [Envoy documentation](https://www.envoyproxy.io/ko/docs/envoy/latest/intro/arch_overview/upstream/load_balancing/priority).
...
[Locality load balancing reference guide](/ko/docs/reference/config/networking/destination-rule#LocalityLoadBalancerSetting)
for options.
