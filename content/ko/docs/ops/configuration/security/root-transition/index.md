...
aliases:
  ...
  - /ko/docs/ops/security/root-transition
...
[here](https://www.envoyproxy.io/ko/docs/envoy/latest/intro/arch_overview/operations/hot_restart) and
...
1. Check the version of your sidecars and upgrade if needed:
    ...
    To upgrade, follow the Istio [upgrade procedure](/ko/docs/setup/upgrade/)
...
1. Execute a root certificate transition:
    ...
    [Envoy hot restart](https://www.envoyproxy.io/ko/docs/envoy/latest/intro/arch_overview/operations/hot_restart)
    ...
    condition.
    The [Istio upgrade guide](/ko/docs/setup/upgrade/)
