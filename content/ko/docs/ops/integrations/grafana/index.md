---
title: 그라파나
description: 이스티오 대시보드를 설정하기 위해 그라파나와 결합하는 방법.
weight: 27
...
To quickly import the Istio dashboards to an existing Grafana instance, you can use the [**Import** button in the Grafana UI](https://grafana.com/ko/docs/grafana/latest/reference/export_import/#importing-a-dashboard) to add the dashboard links above. When you import the dashboards, note that you must select a Prometheus data source.
...
* [Grafana provisioning](https://grafana.com/ko/docs/grafana/latest/administration/provisioning/#dashboards) official documentation.
