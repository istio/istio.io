---
title: Istioctl 설치
description: 철저한 평가 또는 프로덕션 사용을 위해 모든 이스티오 구성 프로파일을 설치하고 사용자 정의한다.
weight: 10
...
[quick start instructions](/ko/docs/setup/getting-started) instead.

This installation guide uses the [istioctl](/ko/docs/reference/commands/istioctl/) command line
...
[configuration profiles](/ko/docs/setup/additional-setup/config-profiles/)
and then further customize the configuration for your specific needs.

The `istioctl` command supports the full [`IstioOperator` API](/ko/docs/reference/config/istio.operator.v1alpha1/)
...
[Istio Operator](/ko/docs/setup/install/operator), instead of doing it manually using `istioctl`.
{{< /tip >}}
...
[`IstioOperator` API](/ko/docs/reference/config/istio.operator.v1alpha1/).
...
that you follow [these steps](/ko/docs/ops/best-practices/security/#configure-third-party-service-account-tokens) if your
...
- [The `IstioOperator` API](/ko/docs/reference/config/istio.operator.v1alpha1/)
...
{{< tip >}}
For backwards compatibility, the previous [Helm installation options](https://archive.istio.io/v1.4/ko/docs/reference/config/installation-options/), with the exception of Kubernetes resource settings,
...
[`IstioOperator` API](/ko/docs/reference/config/istio.operator.v1alpha1/), gateways are defined as a list type.
...
Each component has a [`KubernetesResourceSpec`](/ko/docs/reference/config/istio.operator.v1alpha1/#KubernetesResourcesSpec),
which allows the following settings to be changed. Use this list to identify the setting to customize:

1. [Resources](https://kubernetes.io/ko/docs/concepts/configuration/manage-compute-resources-container/#resource-requests-and-limits-of-pod-and-container)
1. [Readiness probes](https://kubernetes.io/ko/docs/tasks/configure-pod-container/configure-liveness-readiness-probes/)
1. [Replica count](https://kubernetes.io/ko/docs/concepts/workloads/controllers/deployment/)
1. [`HorizontalPodAutoscaler`](https://kubernetes.io/ko/docs/tasks/run-application/horizontal-pod-autoscale/)
1. [`PodDisruptionBudget`](https://kubernetes.io/ko/docs/concepts/workloads/pods/disruptions/#how-disruption-budgets-work)
1. [Pod annotations](https://kubernetes.io/ko/docs/concepts/overview/working-with-objects/annotations/)
1. [Service annotations](https://kubernetes.io/ko/docs/concepts/overview/working-with-objects/annotations/)
1. [`ImagePullPolicy`](https://kubernetes.io/ko/docs/concepts/containers/images/)
1. [Priority class name](https://kubernetes.io/ko/docs/concepts/configuration/pod-priority-preemption/#priorityclass)
1. [Node selector](https://kubernetes.io/ko/docs/concepts/configuration/assign-pod-node/#nodeselector)
1. [Affinity and anti-affinity](https://kubernetes.io/ko/docs/concepts/configuration/assign-pod-node/#affinity-and-anti-affinity)
1. [Service](https://kubernetes.io/ko/docs/concepts/services-networking/service/)
1. [Toleration](https://kubernetes.io/ko/docs/concepts/configuration/taint-and-toleration/)
1. [Strategy](https://kubernetes.io/ko/docs/concepts/workloads/controllers/deployment/)
1. [Env](https://kubernetes.io/ko/docs/tasks/inject-data-application/define-environment-variable-container/)

All of these Kubernetes settings use the Kubernetes API definitions, so [Kubernetes documentation](https://kubernetes.io/ko/docs/concepts/) can be used for reference.
...
The `IstioOperator` API includes a pass-through interface to the [Helm API](https://archive.istio.io/v1.4/ko/docs/reference/config/installation-options/)
...
through the `IstioOperator` [overlays](/ko/docs/reference/config/istio.operator.v1alpha1/#K8sObjectOverlay) API, after it is
