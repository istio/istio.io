---
title: 사이드카 설치
description: 사이드카 인젝터 웹훅을 사용하여 애플리케이션 파드에 자동으로 이스티오 사이드카를 설치하거나 istioctl CLI를 사용하여 수동으로 설치한다.
weight: 45
...
ways of injecting the Istio sidecar into a pod: manually using the [`istioctl`](/ko/docs/reference/commands/istioctl)
...
To manually inject a deployment, use [`istioctl kube-inject`](/ko/docs/reference/commands/istioctl/#istioctl-kube-inject):
...
[mutating webhook admission controller](https://kubernetes.io/ko/docs/reference/access-authn-authz/admission-controllers/) provided by Istio.

{{< tip >}}
While admission controllers are enabled by default, some Kubernetes distributions may disable them. If this is the case, follow the instructions to [turn on admission controllers](https://kubernetes.io/ko/docs/reference/access-authn-authz/admission-controllers/#how-do-i-turn-on-an-admission-controller).
{{< /tip >}}
...
When Kubernetes invokes the webhook, the [`admissionregistration.k8s.io/v1beta1#MutatingWebhookConfiguration`](https://kubernetes.io/ko/docs/reference/generated/kubernetes-api/v1.18/#mutatingwebhookconfiguration-v1beta1-admissionregistration-k8s-io)
...
for the [`MutatingWebhookConfiguration` API](https://kubernetes.io/ko/docs/reference/generated/kubernetes-api/v1.18/#mutatingwebhookconfiguration-v1beta1-admissionregistration-k8s-io)
...
type SidecarTemplateData struct {
    ...
    Spec           *corev1.PodSpec
    ProxyConfig    *meshconfig.ProxyConfig  // Defined by https://istio.io/ko/docs/reference/config/service-mesh.html#proxyconfig
    MeshConfig     *meshconfig.MeshConfig   // Defined by https://istio.io/ko/docs/reference/config/service-mesh.html#meshconfig
}
{{< /text >}}
...
The label selector approach gives a lot of flexibility on how to express those exceptions. Take a look at [these docs](https://kubernetes.io/ko/docs/concepts/overview/working-with-objects/labels/#resources-that-support-set-based-requirements) to see what you can do with them!
