---
title: 시작하기
description: 이스티오의 기능을 빠르고 쉽게 시도한다.
weight: 5
...
advanced [deployment models](/ko/docs/ops/deployment/deployment-models/), see
[Customizable Install with `istioctl`](/ko/docs/setup/install/istioctl/)
instead.
...
example [Minikube](https://kubernetes.io/ko/docs/tasks/tools/install-minikube/) or
others specified by the
[platform-specific setup instructions](/ko/docs/setup/platform-setup/).
...
1.  Move to the Istio package directory. For example, if the package is
    ...
    - The [`istioctl`](/ko/docs/reference/commands/istioctl) client binary in the
      `bin/` directory.
...
1.  For this installation, we use the `demo`
    [configuration profile](/ko/docs/setup/additional-setup/config-profiles/). It's
...
1.  Deploy the [`Bookinfo` sample application](/ko/docs/examples/bookinfo/):
...
[Istio Ingress Gateway](/ko/docs/concepts/traffic-management/#gateways), which maps a path to a
...
Istio integrates with [several](/ko/docs/ops/integrations) different telemetry applications. These can help you gain
...
Use the following instructions to deploy the [Kiali](/ko/docs/ops/integrations/kiali/) dashboard, along with [Prometheus](/ko/docs/ops/integrations/prometheus/), [Grafana](/ko/docs/ops/integrations/grafana), and [Jaeger](/ko/docs/ops/integrations/jaeger/).
...
[`Bookinfo` cleanup](/ko/docs/examples/bookinfo/#cleanup).
