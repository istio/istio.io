...
skip_seealso: true
aliases:
    - /ko/docs/setup/kubernetes/prepare/platform-setup/docker-for-desktop/
    - /ko/docs/setup/kubernetes/prepare/platform-setup/docker/
    - /ko/docs/setup/kubernetes/platform-setup/docker/
