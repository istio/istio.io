...
skip_seealso: true
aliases:
    - /ko/docs/setup/kubernetes/prepare/platform-setup/gke/
    - /ko/docs/setup/kubernetes/platform-setup/gke/
...
1. Create a new cluster.
    ...
    installing with the
    [demo configuration profile](/ko/docs/setup/additional-setup/config-profiles/),
    ...
    [network-policy](https://cloud.google.com/kubernetes-engine/ko/docs/how-to/network-policy)
