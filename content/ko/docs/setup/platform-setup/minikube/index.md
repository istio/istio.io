...
skip_seealso: true
aliases:
    - /ko/docs/setup/kubernetes/prepare/platform-setup/minikube/
    - /ko/docs/setup/kubernetes/platform-setup/minikube/
...
- To enable the [Secret Discovery Service](https://www.envoyproxy.io/ko/docs/envoy/latest/configuration/security/secret#sds-configuration) (SDS) for your mesh, you must add [extra configurations](https://kubernetes.io/ko/docs/tasks/configure-pod-container/configure-service-account/#service-account-token-volume-projection) to your Kubernetes deployment.
Refer to the [`api-server` reference docs](https://kubernetes.io/ko/docs/reference/command-line-tools-reference/kube-apiserver/) for the most up-to-date flags.

## Installation steps

1.  Install the latest version of
    [minikube](https://kubernetes.io/ko/docs/setup/minikube/) and a
    [minikube hypervisor driver](https://kubernetes.io/ko/docs/tasks/tools/install-minikube/#install-a-hypervisor).
...
1.  (Optional, recommended) If you want minikube to provide a load balancer for use
    ...
    [minikube tunnel](https://minikube.sigs.k8s.io/ko/docs/tasks/loadbalancer/#using-minikube-tunnel) feature.
