...
skip_seealso: true
aliases:
    - /ko/docs/setup/kubernetes/prepare/platform-setup/ibm/
    - /ko/docs/setup/kubernetes/platform-setup/ibm/
...
Refer to [Istio on IBM Cloud Kubernetes Service](https://cloud.ibm.com/ko/docs/containers?topic=containers-istio)
for details and instructions.
{{< /tip >}}

To prepare a cluster before manually installing Istio, proceed as follows:

1.  [Install the IBM Cloud CLI, the IBM Cloud Kubernetes Service plug-in, and the Kubernetes CLI](https://cloud.ibm.com/ko/docs/containers?topic=containers-cs_cli_install).
...
1.  Create a standard Kubernetes cluster using the following command.
    ...
    The IBM Cloud Kubernetes Service [Locations Reference Guide](https://cloud.ibm.com/ko/docs/containers?topic=containers-regions-and-zones)
