...
skip_seealso: true
aliases:
    - /ko/docs/setup/kubernetes/prepare/platform-setup/openshift/
    - /ko/docs/setup/kubernetes/platform-setup/openshift/
...
{{< warning >}}
OpenShift is incompatible with the Istio `proxy-init` container. Make sure to install Istio using the [CNI](/ko/docs/setup/additional-setup/cni/) plugin.
{{< /warning >}}
...
Now you can install Istio using the [CNI](/ko/docs/setup/additional-setup/cni/) instructions.
