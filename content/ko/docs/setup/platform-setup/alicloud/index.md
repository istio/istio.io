...
skip_seealso: true
aliases:
    - /ko/docs/setup/kubernetes/prepare/platform-setup/alicloud/
    - /ko/docs/setup/kubernetes/platform-setup/alicloud/
...
[Alibaba Application Catalog instructions](https://archive.istio.io/v1.1/ko/docs/setup/kubernetes/install/platform/alicloud/)
instead.
{{< /tip >}}
