...
weight: 35
aliases:
    - /ko/docs/setup/kubernetes/platform-setup/gardener/
skip_seealso: true
...
[documentation](https://github.com/gardener/gardener/blob/master/ko/docs/README.md)
...
1.  [Install the `kubectl` CLI](https://kubernetes.io/ko/docs/tasks/tools/install-kubectl/).
...
1.  [Configure access to your Gardener project](https://kubernetes.io/ko/docs/tasks/tools/install-kubectl/#verifying-kubectl-configuration)
