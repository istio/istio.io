...
skip_seealso: true
aliases:
    - /ko/docs/setup/kubernetes/prepare/platform-setup/azure/
    - /ko/docs/setup/kubernetes/platform-setup/azure/
...
1. [Follow the instructions](https://github.com/Azure/aks-engine/blob/master/ko/docs/tutorials/quickstart.md#install-aks-engine) to get and install the `aks-engine` binary.
