...
如果没有，则 destination rule 将不会在 [destination rule 查找路径](/zh/docs/ops/best-practices/traffic-management/deploy-guidelines/#cross-namespace-configuration-sharing)，客户端请求将失败。
