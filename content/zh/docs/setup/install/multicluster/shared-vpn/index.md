...
Follow this guide to install an Istio [multicluster service mesh](/docs/setup/prep/deployment-models/#multiple-clusters)
...
[control plane](/docs/setup/prep/deployment-models/#control-plane-models).
