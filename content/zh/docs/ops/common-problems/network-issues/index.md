...
- `UF`: 未能连接到上游，如果你正在使用 Istio 认证，请检查[mutual-tls 配置冲突](#errors-after-setting-destination-rule)。
...
## 当为多个 gateway 配置了相同的 TLS 证书导致 404 异常{#errors-occur-when-multiple-gateways-configured-with-same-TLS-certificate}
