...
也可以使用基于[非发行版镜像](https://github.com/GoogleContainerTools/distroless)的替代镜像。
...
这与非发行版 Istio 镜像中使用的基础镜像相同，并且包含各种可用于调试 Istio 的工具。
但是，任何镜像都可以起作用。
