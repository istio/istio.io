...
自那时起，该项目推动了服务网格领域的诸多进步，包括[多集群与多网络拓扑](/zh/docs/ops/deployment/deployment-models/)、
[基于 WebAssembly 与 Lua 的可扩展性](/zh/docs/concepts/extensibility/trafficextension/)、
[Kubernetes Gateway API 的开发](/zh/blog/2022/gateway-api-beta/)，
以及通过 [Ambient 模式](/zh/docs/ambient/overview/)将网格基础设施的关注点从应用开发者身上剥离。
