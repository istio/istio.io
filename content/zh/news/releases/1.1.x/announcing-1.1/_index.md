...
One of our prime areas of focus has been [performance and scalability](/zh/docs/ops/performance-and-scalability/).
...
[Pilot](/zh/docs/ops/architecture/#pilot)) was overly
resource hungry.
...
results in our updated [performance ans scalability concept](/zh/docs/ops/performance-and-scalability/).
...
We have also improved the [multicluster capabilities and usability](/zh/docs/ops/prep/deployment-models/).
We listened to the community and improved defaults for traffic control and
policy. We introduced a new component called
[Galley](/zh/docs/ops/architecture/#galley). Galley validates that sweet,
...
[control plane models](/zh/docs/ops/prep/deployment-models/#control-plane-models)
