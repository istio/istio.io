---
title: 发布 Istio 1.29.5
linktitle: 1.29.5
subtitle: 补丁发布
description: Istio 1.29.5 补丁发布。
publishdate: 2026-06-24
release: 1.29.5
aliases:
    - /zh/news/announcing-1.29.5
---


此版本包含一些错误修复，以提高稳定性。
本发行说明描述了 Istio 1.29.4 和 Istio 1.29.5 之间的区别。
...
- **修复** 修复了多集群 Secret 控制器中的一个 Panic（`close of closed channel`）问题；
  该问题可能在远程集群的 kubeconfig Secret 连续快速更新两次时触发。
