---
title: 发布 Istio 1.11.1 版本
linktitle: 1.11.1
subtitle: 补丁发布
description: Istio 1.11.1 补丁发布。
...
- [CVE-2021-32781](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2021-32781) (CVSS score 8.6, High)：Envoy 存在一个可远程利用的漏洞，该漏洞影响 Envoy 的解压器、json-transcoder 或 grpc-web 扩展，或修改和增加请求或响应体的大小的专有扩展。
