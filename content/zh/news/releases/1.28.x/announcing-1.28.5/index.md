---
title: 发布 Istio 1.28.5
linktitle: 1.28.5
subtitle: 补丁发布
description: Istio 1.28.5 补丁发布。
publishdate: 2026-03-10
release: 1.28.5
aliases:
    - /zh/news/announcing-1.28.5
---

此版本包含一些错误修复，以提高稳定性。
本发行说明描述了 Istio 1.28.4 和 Istio 1.28.5 之间的区别。
...
- **修复** 修复了一个问题，当多个引用不同 `InferencePool` 的 `HTTPRoute`
  挂载到同一个 Gateway 上时，在进行 `VirtualService` 合并过程中，`InferencePool` 配置会丢失。
