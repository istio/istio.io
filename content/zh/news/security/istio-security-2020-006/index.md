...
* 对于 Istio 1.4.x 部署: 请升级至 [Istio 1.4.10](/news/releases/1.4.x/announcing-1.4.10) 或更高的版本。
* 对于 Istio 1.5.x 部署: 请升级至 [Istio 1.5.5](/news/releases/1.5.x/announcing-1.5.5) 或更高的版本。
* 对于 Istio 1.6.x 部署: 请升级至 [Istio 1.6.2](/news/releases/1.6.x/announcing-1.6.2) 或更高的版本。
