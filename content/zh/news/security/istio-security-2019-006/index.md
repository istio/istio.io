...
* 解决方法: 通过自定义安装 Istio 可以防止对该漏洞的利用(as described in [installation options](/zh/docs/reference/config/installation-options/#pilot-options))，在使用 Helm 时添加以下选项:
