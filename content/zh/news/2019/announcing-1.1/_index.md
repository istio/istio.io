...
We have also improved the [multicluster capabilities and usability](/docs/setup/prep/deployment-models/).
...
[control plane models](/docs/setup/prep/deployment-models/#control-plane-models)
