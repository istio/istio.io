...
1.  Set the `KUBECONFIG` environment variable to store the `${NAMESPACE}-user-config.yaml`
    configuration file generated while [setting up the cluster](/docs/tutorial/microservices-istio/setup-kubernetes-cluster):
...
You set up your local computer and you have a [Kubernetes cluster ready](/docs/tutorial/microservices-istio/setup-kubernetes-cluster) for learning.
You are ready to [run a single service locally](/docs/tutorial/microservices-istio/single/). Enjoy!
