...
To fix, add a `port` to the virtual service [Destination](docs/reference/config/networking/v1alpha3/virtual-service/#Destination) to disambiguate which service port should be routed to.
