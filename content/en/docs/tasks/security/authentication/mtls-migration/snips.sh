...
! IFS= read -r -d '' snip_set_up_the_cluster_3_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_set_up_the_cluster_4_out <<\ENDSNIP
No resources found
ENDSNIP
...
! IFS= read -r -d '' snip_set_up_the_cluster_5_out <<\ENDSNIP
No resources found
ENDSNIP
...
! IFS= read -r -d '' snip_lock_down_to_mutual_tls_by_namespace_2_out <<\ENDSNIP
sleep.foo to httpbin.foo: 200
sleep.foo to httpbin.bar: 200
sleep.bar to httpbin.foo: 200
sleep.bar to httpbin.bar: 200
...
! IFS= read -r -d '' snip_lock_down_to_mutual_tls_by_namespace_3_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_clean_up_the_example_2_out <<\ENDSNIP
