...
wget --no-verbose https://raw.githubusercontent.com/istio/istio/release-1.29/security/tools/jwt/samples/gen-jwt.py
}

snip_enduser_authentication_11() {
wget --no-verbose https://raw.githubusercontent.com/istio/istio/release-1.29/security/tools/jwt/samples/key.pem
}
