...
! IFS= read -r -d '' snip_setup_2_out <<\ENDSNIP
200
ENDSNIP
...
! IFS= read -r -d '' snip_setup_3_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_setup_4_out <<\ENDSNIP
No resources found
ENDSNIP
...
! IFS= read -r -d '' snip_setup_5_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_auto_mutual_tls_1_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_auto_mutual_tls_2_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_globally_enabling_istio_mutual_tls_in_strict_mode_2_out <<\ENDSNIP
sleep.foo to httpbin.foo: 200
sleep.foo to httpbin.bar: 200
sleep.foo to httpbin.legacy: 200
sleep.bar to httpbin.foo: 200
...
! IFS= read -r -d '' snip_namespacewide_policy_2_out <<\ENDSNIP
sleep.foo to httpbin.foo: 200
sleep.foo to httpbin.bar: 200
sleep.foo to httpbin.legacy: 200
sleep.bar to httpbin.foo: 200
...
! IFS= read -r -d '' snip_enable_mutual_tls_per_workload_2_out <<\ENDSNIP
sleep.foo to httpbin.foo: 200
sleep.foo to httpbin.bar: 200
sleep.foo to httpbin.legacy: 200
sleep.bar to httpbin.foo: 200
...
! IFS= read -r -d '' snip_enable_mutual_tls_per_workload_5_out <<\ENDSNIP
sleep.foo to httpbin.foo: 200
sleep.foo to httpbin.bar: 200
sleep.foo to httpbin.legacy: 200
sleep.bar to httpbin.foo: 200
...
! IFS= read -r -d '' snip_policy_precedence_2_out <<\ENDSNIP
200
ENDSNIP
...
! IFS= read -r -d '' snip_enduser_authentication_4_out <<\ENDSNIP
200
ENDSNIP
...
! IFS= read -r -d '' snip_enduser_authentication_7_out <<\ENDSNIP
200
ENDSNIP
...
! IFS= read -r -d '' snip_enduser_authentication_8_out <<\ENDSNIP
401
ENDSNIP
...
! IFS= read -r -d '' snip_enduser_authentication_9_out <<\ENDSNIP
200
ENDSNIP

snip_enduser_authentication_10() {
wget --no-verbose https://raw.githubusercontent.com/istio/istio/release-1.21/security/tools/jwt/samples/gen-jwt.py
}

snip_enduser_authentication_11() {
wget --no-verbose https://raw.githubusercontent.com/istio/istio/release-1.21/security/tools/jwt/samples/key.pem
}
...
! IFS= read -r -d '' snip_enduser_authentication_12_out <<\ENDSNIP
200
200
200
200
...
! IFS= read -r -d '' snip_require_a_valid_token_3_out <<\ENDSNIP
403
ENDSNIP
...
! IFS= read -r -d '' snip_require_valid_tokens_perpath_3_out <<\ENDSNIP
403
ENDSNIP
...
! IFS= read -r -d '' snip_require_valid_tokens_perpath_4_out <<\ENDSNIP
200
ENDSNIP
