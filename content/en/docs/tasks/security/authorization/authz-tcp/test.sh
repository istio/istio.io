...
_verify_same snip_configure_allow_authorization_policy_for_a_tcp_workload_2 "$snip_configure_allow_authorization_policy_for_a_tcp_workload_2_out"

_verify_same snip_configure_allow_authorization_policy_for_a_tcp_workload_3 "$snip_configure_allow_authorization_policy_for_a_tcp_workload_3_out"

_verify_same snip_configure_allow_authorization_policy_for_a_tcp_workload_4 "$snip_configure_allow_authorization_policy_for_a_tcp_workload_4_out"

snip_configure_allow_authorization_policy_for_a_tcp_workload_5
_wait_for_istio authorizationpolicy foo tcp-policy

_verify_same snip_configure_allow_authorization_policy_for_a_tcp_workload_6 "$snip_configure_allow_authorization_policy_for_a_tcp_workload_6_out"

_verify_same snip_configure_allow_authorization_policy_for_a_tcp_workload_7 "$snip_configure_allow_authorization_policy_for_a_tcp_workload_7_out"

snip_configure_deny_authorization_policy_for_a_tcp_workload_1
_wait_for_istio authorizationpolicy foo tcp-policy

_verify_same snip_configure_deny_authorization_policy_for_a_tcp_workload_2 "$snip_configure_deny_authorization_policy_for_a_tcp_workload_2_out"

_verify_same snip_configure_deny_authorization_policy_for_a_tcp_workload_3 "$snip_configure_deny_authorization_policy_for_a_tcp_workload_3_out"

snip_configure_deny_authorization_policy_for_a_tcp_workload_4
_wait_for_istio authorizationpolicy foo tcp-policy

_verify_same snip_configure_deny_authorization_policy_for_a_tcp_workload_5 "$snip_configure_deny_authorization_policy_for_a_tcp_workload_5_out"
