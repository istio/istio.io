...
snip_configure_access_control_for_a_tcp_workload_11
_wait_for_istio authorizationpolicy foo tcp-policy

_verify_same snip_configure_access_control_for_a_tcp_workload_12 "$snip_configure_access_control_for_a_tcp_workload_12_out"

_verify_same snip_configure_access_control_for_a_tcp_workload_13 "$snip_configure_access_control_for_a_tcp_workload_13_out"
# @cleanup
snip_clean_up_1
