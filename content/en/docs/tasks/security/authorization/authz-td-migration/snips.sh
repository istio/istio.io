...
istioctl install --set PILOT_ENABLE_CONFIG_DISTRIBUTION_TRACKING --set profile=demo --set meshConfig.trustDomain=old-td
}
...
istioctl install --set PILOT_ENABLE_CONFIG_DISTRIBUTION_TRACKING --set profile=demo --set meshConfig.trustDomain=new-td
}
...
spec:
  meshConfig:
    ...
    trustDomainAliases:
      - old-td
EOF
istioctl install --set PILOT_ENABLE_CONFIG_DISTRIBUTION_TRACKING --set profile=demo -f td-installation.yaml -y
}
