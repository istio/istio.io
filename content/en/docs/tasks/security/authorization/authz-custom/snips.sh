...
! IFS= read -r -d '' snip_deploy_the_external_authorizer_1_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_deploy_the_external_authorizer_2_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_enable_with_external_authorization_2_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_enable_with_external_authorization_3_out <<\ENDSNIP
{
  "headers": {
    "Accept": "*/*",
    "Host": "httpbin:8000",
...
! IFS= read -r -d '' snip_enable_with_external_authorization_4_out <<\ENDSNIP
200
ENDSNIP
...
! IFS= read -r -d '' snip_enable_with_external_authorization_5_out <<\ENDSNIP
2021/01/07 22:55:47 Starting HTTP server at [::]:8000
2021/01/07 22:55:47 Starting gRPC server at [::]:9000
