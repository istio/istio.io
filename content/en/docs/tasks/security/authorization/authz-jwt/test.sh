...
_rewrite_jwks_uri snip_allow_requests_with_valid_jwt_and_spacedelimited_claims_3
_wait_for_resource requestauthentication foo jwt-example
...
_verify_same snip_allow_requests_with_valid_jwt_and_spacedelimited_claims_6 "$snip_allow_requests_with_valid_jwt_and_spacedelimited_claims_6_out"

snip_allow_requests_with_valid_jwt_and_spacedelimited_claims_7

_verify_same snip_allow_requests_with_valid_jwt_and_spacedelimited_claims_8 "$snip_allow_requests_with_valid_jwt_and_spacedelimited_claims_8_out"
