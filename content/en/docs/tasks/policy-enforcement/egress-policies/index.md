...
description: This task shows you how to configure Istio's resources to enforce policies related to outbound mesh traffic
weight: 10
keywords: [policies,egress]
owner: istio/wg-policies-and-telemetry-maintainers
test: no
---

This task shows you how to use Istio's `AuthorizationPolicy` resource to enforce outbound traffic policies. This task showcases how to apply policies at different granularity levels like mesh-wide, per namespace and per workload to control traffic going out the mesh.
