...
! IFS= read -r -d '' snip_verify_global_rate_limit_1_out <<\ENDSNIP
200
429
ENDSNIP
...
! IFS= read -r -d '' snip_verify_global_rate_limit_2_out <<\ENDSNIP
200
200
429
ENDSNIP
...
! IFS= read -r -d '' snip_verify_local_rate_limit_1_out <<\ENDSNIP
