...
! IFS= read -r -d '' snip_verify_traffic_stays_in_region1zone1_1_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_failover_to_region1zone2_2_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_failover_to_region2zone3_2_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_failover_to_region3zone4_2_out <<\ENDSNIP
