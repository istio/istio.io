...
*   For macOS users, verify that you use openssl version at least 1.1:
    ...
    If the previous command outputs a version `1.1` or later of OpenSSL as shown, your `openssl` command
