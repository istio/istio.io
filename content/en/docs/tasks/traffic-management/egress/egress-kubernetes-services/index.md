...
already uses TLS, the traffic is already encrypted and you can just disable Istio's mutual TLS.
     ...
     {{< warning >}}
     This page describes how Istio integrates with existing Kubernetes configurations. For new deployments, we recommend following [Accessing Egress Services](/docs/tasks/traffic-management/egress/egress-control/).
     {{< /warning >}}
