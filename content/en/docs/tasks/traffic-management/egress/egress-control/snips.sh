...
! IFS= read -r -d '' snip_envoy_passthrough_to_external_services_3_out <<\ENDSNIP
HTTP/2 200
HTTP/2 200
ENDSNIP
...
! IFS= read -r -d '' snip_change_to_the_blockingbydefault_policy_3_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_access_an_external_http_service_2_out <<\ENDSNIP
{
  "headers": {
    "Accept": "*/*",
    "Host": "httpbin.org",
...
! IFS= read -r -d '' snip_access_an_external_http_service_3_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_access_an_external_https_service_2_out <<\ENDSNIP
HTTP/2 200
ENDSNIP
...
! IFS= read -r -d '' snip_access_an_external_https_service_3_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_manage_traffic_to_external_services_1_out <<\ENDSNIP
200
real    0m5.024s
user    0m0.003s
sys     0m0.003s
...
! IFS= read -r -d '' snip_manage_traffic_to_external_services_4_out <<\ENDSNIP
504
real    0m3.149s
user    0m0.004s
sys     0m0.004s
...
! IFS= read -r -d '' snip_ibm_cloud_kubernetes_service_1_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_google_kubernetes_engine_gke_1_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_kubenet_1_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_azure_cni_1_out <<\ENDSNIP
    "serviceCidr": "10.0.0.0/16",
    "serviceCidrs": [
ENDSNIP
...
! IFS= read -r -d '' snip_azure_cni_2_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_minikube_docker_for_desktop_bare_metal_1_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_access_the_external_services_1_out <<\ENDSNIP
{
  "headers": {
    "Accept": "*/*",
    "Host": "httpbin.org",
