...
snip_set_the_outbound_traffic_policy_mode_to_your_desired_value_1() {
...
! read -r -d '' snip_set_the_outbound_traffic_policy_mode_to_your_desired_value_1_out <<\ENDSNIP
mode: ALLOW_ANY
ENDSNIP

snip_set_the_outbound_traffic_policy_mode_to_your_desired_value_2() {
kubectl get configmap istio -n istio-system -o yaml | sed 's/mode: ALLOW_ANY/mode: REGISTRY_ONLY/g' | kubectl replace -n istio-system -f -
}

! read -r -d '' snip_set_the_outbound_traffic_policy_mode_to_your_desired_value_2_out <<\ENDSNIP
configmap/istio replaced
ENDSNIP

snip_set_the_outbound_traffic_policy_mode_to_your_desired_value_3() {
kubectl get configmap istio -n istio-system -o yaml | sed 's/mode: REGISTRY_ONLY/mode: ALLOW_ANY/g' | kubectl replace -n istio-system -f -
}

! read -r -d '' snip_set_the_outbound_traffic_policy_mode_to_your_desired_value_3_out <<\ENDSNIP
configmap/istio replaced
ENDSNIP
