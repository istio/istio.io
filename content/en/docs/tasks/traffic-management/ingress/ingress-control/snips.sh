...
snip_configuring_ingress_routing_based_on_jwt_claims_3() {
curl -s -I -HHost:httpbin.example.com "http://$INGRESS_HOST:$INGRESS_PORT/headers"
}

! read -r -d '' snip_configuring_ingress_routing_based_on_jwt_claims_3_out <<\ENDSNIP
HTTP/1.1 404 Not Found
...
ENDSNIP

snip_configuring_ingress_routing_based_on_jwt_claims_4() {
curl -s -I -HHost:httpbin.example.com "http://$INGRESS_HOST:$INGRESS_PORT/headers" -H "Authorization: Bearer some.invalid.token"
}

! read -r -d '' snip_configuring_ingress_routing_based_on_jwt_claims_4_out <<\ENDSNIP
HTTP/1.1 401 Unauthorized
...
ENDSNIP

snip_configuring_ingress_routing_based_on_jwt_claims_5() {
...
! read -r -d '' snip_configuring_ingress_routing_based_on_jwt_claims_5_out <<\ENDSNIP
{"exp":3537391104,"groups":["group1","group2"],"iat":1537391104,"iss":"testing@secure.istio.io","scope":["scope1","scope2"],"sub":"testing@secure.istio.io"}
ENDSNIP

snip_configuring_ingress_routing_based_on_jwt_claims_6() {
curl -s -I -HHost:httpbin.example.com "http://$INGRESS_HOST:$INGRESS_PORT/headers" -H "Authorization: Bearer $TOKEN_GROUP"
}

! read -r -d '' snip_configuring_ingress_routing_based_on_jwt_claims_6_out <<\ENDSNIP
HTTP/1.1 200 OK
...
ENDSNIP

snip_configuring_ingress_routing_based_on_jwt_claims_7() {
...
! read -r -d '' snip_configuring_ingress_routing_based_on_jwt_claims_7_out <<\ENDSNIP
{"exp":4685989700,"foo":"bar","iat":1532389700,"iss":"testing@secure.istio.io","sub":"testing@secure.istio.io"}
ENDSNIP

snip_configuring_ingress_routing_based_on_jwt_claims_8() {
curl -s -I -HHost:httpbin.example.com "http://$INGRESS_HOST:$INGRESS_PORT/headers" -H "Authorization: Bearer $TOKEN_NO_GROUP"
}

! read -r -d '' snip_configuring_ingress_routing_based_on_jwt_claims_8_out <<\ENDSNIP
HTTP/1.1 404 Not Found
...
ENDSNIP
