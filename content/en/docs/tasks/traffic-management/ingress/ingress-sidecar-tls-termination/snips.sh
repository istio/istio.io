...
! IFS= read -r -d '' snip_verification_2_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_verification_3_out <<\ENDSNIP
NAME                       READY   STATUS    RESTARTS   AGE
...
! IFS= read -r -d '' snip_verification_4_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_verification_5_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_verify_internal_mesh_connectivity_on_port_8080_1_out <<\ENDSNIP
HTTP/1.1 200 OK
server: envoy
...
! IFS= read -r -d '' snip_verify_external_to_internal_mesh_connectivity_on_port_8443_2_out <<\ENDSNIP
server: istio-envoy
...
! IFS= read -r -d '' snip_verify_external_to_internal_mesh_connectivity_on_port_8443_3_out <<\ENDSNIP
