...
-_wait_for_istio gateway istio-io-tcp-traffic-shifting tcp-echo-gateway 2s true
-_wait_for_istio destinationrule istio-io-tcp-traffic-shifting tcp-echo-destination 2s true
-_wait_for_istio virtualservice istio-io-tcp-traffic-shifting tcp-echo 2s true
