...
! IFS= read -r -d '' snip_configuring_the_circuit_breaker_2_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_adding_a_client_3_out <<\ENDSNIP
HTTP/1.1 200 OK
server: envoy
...
! IFS= read -r -d '' snip_tripping_the_circuit_breaker_1_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_tripping_the_circuit_breaker_3_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_tripping_the_circuit_breaker_5_out <<\ENDSNIP
