...
# @setup profile=none
echo "$snip_enable_custom_metrics_1" | istioctl install --skip-confirmation --set tag="$TAG" --set hub="$HUB" -f -
...
echo "$snip_enable_custom_metrics_2" | istioctl install --skip-confirmation --set tag="$TAG" --set hub="$HUB" -f -
