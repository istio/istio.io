...
! IFS= read -r -d '' snip_collecting_new_telemetry_data_1_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_collecting_new_telemetry_data_2_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_collecting_new_telemetry_data_3_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_collecting_new_telemetry_data_4_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_collecting_new_telemetry_data_8_out <<\ENDSNIP
