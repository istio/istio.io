...
! IFS= read -r -d '' snip_customizing_tracing_tags_1 <<\ENDSNIP
apiVersion: telemetry.istio.io/v1alpha1
kind: Telemetry
metadata:
name: mesh-default
...
! IFS= read -r -d '' snip_customizing_tracing_tags_2 <<\ENDSNIP
apiVersion: telemetry.istio.io/v1alpha1
kind: Telemetry
metadata:
  name: mesh-default
...
! IFS= read -r -d '' snip_customizing_tracing_tags_3 <<\ENDSNIP
apiVersion: telemetry.istio.io/v1alpha1
kind: Telemetry
metadata:
  name: mesh-default
...
! IFS= read -r -d '' snip_customizing_tracing_tag_length_1 <<\ENDSNIP
apiVersion: install.istio.io/v1alpha1
kind: IstioOperator
spec:
  meshConfig:
