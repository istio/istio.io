...
The project targets supporting four versions of Kubernetes each release. However, due to release schedules this may not be met nor is it guaranteed that these will be the four most recent versions.
