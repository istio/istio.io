...
You can find the precise Envoy commit used by Istio in [`istio/proxy`](https://github.com/istio/proxy/blob/{{< source_branch_name >}}/WORKSPACE#L26) repository. Look for the `ENVOY_SHA` variable.
