...
See [the L4 policy guide](/docs/ambient/l4-policy/targeting-policies) for more information, including when to attach policies to waypoints for TCP-only use cases.
