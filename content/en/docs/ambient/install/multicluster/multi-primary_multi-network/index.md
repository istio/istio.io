...
{{< warning >}}
If you are running a revisioned instance of istiod and you don't have a default revision set, you may need to add the `istio.io/rev` label to this `Gateway` manifest.
{{< /warning >}}
