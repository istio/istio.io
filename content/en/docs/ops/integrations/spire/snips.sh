...
! IFS= read -r -d '' snip_option_2_manual_registration_3_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_option_2_manual_registration_4_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_verifying_that_identities_were_created_for_workloads_1_out <<\ENDSNIP
Found 2 entries
...
! IFS= read -r -d '' snip_get_svid_subject_out <<\ENDSNIP
