...
The Kiali project offers its own [quick start guide](https://kiali.io/documentation/quick-start) and [customizable installation methods](https://kiali.io/documentation/installation-guide). We recommend production users follow those instructions to ensure they stay up to date with the latest versions and best practices.
