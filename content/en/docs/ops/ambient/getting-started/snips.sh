...
istioctl install --set values.pilot.env.PILOT_ENABLE_CONFIG_DISTRIBUTION_TRACKING=true --set profile=ambient --set ingressGateways.istio-ingressgateway.enabled=true --skip-confirmation
}
