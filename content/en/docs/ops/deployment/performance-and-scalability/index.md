...
the two proxies add about 0.17 ms and 0.20 ms to the 90th and 99th percentile latency, respectively, over the baseline data plane latency. Waypoint is better than sidecar.
...
- `ambient: L4` ambient:ambient
- `ambient: L4+L7` waypoint:waypoint
