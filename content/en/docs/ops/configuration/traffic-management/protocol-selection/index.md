...
{{< tip >}}
Server First protocols, such as MySQL, are incompatible with automatic protocol selection. See [Server first protocols](/docs/ops/configuration/traffic-management/traffic-requirements/#server-first-protocols) for more information.
{{< /tip >}}
