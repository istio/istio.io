...
`istioctl` or the values file used during the Helm installation of the [istio-discovery](https://github.com/istio/istio/tree/master/manifests/charts/istio-control/istio-discovery) chart.
