...
! IFS= read -r -d '' snip_dns_capture_in_action_3_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_address_auto_allocation_2_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_external_tcp_services_without_vips_5_out <<\ENDSNIP
