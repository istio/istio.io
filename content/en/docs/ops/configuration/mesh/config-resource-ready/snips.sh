...
istioctl install --set PILOT_ENABLE_CONFIG_DISTRIBUTION_TRACKING --set values.pilot.env.PILOT_ENABLE_STATUS=true --set values.pilot.env.PILOT_ENABLE_CONFIG_DISTRIBUTION_TRACKING=true --set values.global.istiod.enableAnalysis=true
}
