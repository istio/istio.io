...
practice is to use [namespace tenancy](https://github.com/istio/istio.io/blob/master/content/en/docs/ops/deployment/deployment-models/index.md#namespace-tenancy)
