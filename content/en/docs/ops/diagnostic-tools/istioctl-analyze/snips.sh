...
status:
  ...
  validationMessages:
  - documentationUrl: https://istio.io/v1.17/docs/reference/config/analysis/ist0101/
    level: ERROR
    type:
      code: IST0101
ENDSNIP
...
istioctl install --set PILOT_ENABLE_CONFIG_DISTRIBUTION_TRACKING --set values.global.istiod.enableAnalysis=true
}
