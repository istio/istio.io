...
export NAMESPACE=$(kubectl config view -o jsonpath={.contexts..namespace})

snip__1

for services in "details" "productpage" "ratings" "reviews"; do
   _wait_for_istio destinationrule "${NAMESPACE}" "$services"
done
