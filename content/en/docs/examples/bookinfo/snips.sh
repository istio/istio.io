...
! IFS= read -r -d '' snip_start_the_application_services_4_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_start_the_application_services_5_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_start_the_application_services_6_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_determine_the_ingress_ip_and_port_1_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_determine_the_ingress_ip_and_port_2_out <<\ENDSNIP
NAME               AGE
...
! IFS= read -r -d '' snip_determine_the_ingress_ip_and_port_3_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_confirm_the_app_is_accessible_from_outside_the_cluster_1_out <<\ENDSNIP
<title>Simple Bookstore App</title>
ENDSNIP
