...
{ kubectl kustomize "github.com/kubernetes-sigs/gateway-api/config/crd?ref=b5e115d06513555c7bc81bf7535f896105aac450" | kubectl apply -f -; }
}
...
snip_uninstall_4() {
kubectl kustomize "github.com/kubernetes-sigs/gateway-api/config/crd/experimental?ref=b5e115d06513555c7bc81bf7535f896105aac450" | kubectl delete -f -
}

snip_uninstall_5() {
kubectl kustomize "github.com/kubernetes-sigs/gateway-api/config/crd?ref=b5e115d06513555c7bc81bf7535f896105aac450" | kubectl delete -f -
}
