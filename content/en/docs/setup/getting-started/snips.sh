...
! IFS= read -r -d '' snip_install_istio_1_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_install_istio_2_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_deploy_the_sample_application_1_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_deploy_the_sample_application_2_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_deploy_the_sample_application_3_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_deploy_the_sample_application_4_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_open_the_application_to_outside_traffic_1_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_open_the_application_to_outside_traffic_2_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_determining_the_ingress_ip_and_ports_3_out <<\ENDSNIP
127.0.0.1
ENDSNIP
...
! IFS= read -r -d '' snip_determining_the_ingress_ip_and_ports_4_out <<\ENDSNIP
80
ENDSNIP
...
! IFS= read -r -d '' snip_determining_the_ingress_ip_and_ports_5_out <<\ENDSNIP
443
ENDSNIP
...
! IFS= read -r -d '' snip_determining_the_ingress_ip_and_ports_6_out <<\ENDSNIP
NAME                   TYPE           CLUSTER-IP       EXTERNAL-IP     PORT(S)                                      AGE
...
! IFS= read -r -d '' snip_determining_the_ingress_ip_and_ports_16_out <<\ENDSNIP
127.0.0.1:80
ENDSNIP
...
! IFS= read -r -d '' snip_view_the_dashboard_1_out <<\ENDSNIP
