...
! IFS= read -r -d '' snip_upgrade_steps_1_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_canary_upgrade_recommended_3_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_canary_upgrade_recommended_5_out <<\ENDSNIP
  NAME                                    READY   STATUS    RESTARTS   AGE     REV
