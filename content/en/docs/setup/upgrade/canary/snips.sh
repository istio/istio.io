...
istiod-1-19-1   ClusterIP   10.96.93.151     <none>        15010/TCP,15012/TCP,443/TCP,15014/TCP   109s
...
istioctl install --set values.pilot.env.PILOT_ENABLE_CONFIG_DISTRIBUTION_TRACKING=true --revision=1-20-3 --set profile=minimal --skip-confirmation
}

snip_usage_2() {
istioctl tag set prod-stable --revision 1-19-1
istioctl tag set prod-canary --revision 1-20-3
}
...
sleep-78ff5975c6-62pzf.app-ns-3     Kubernetes     SYNCED     SYNCED     SYNCED     SYNCED     NOT SENT     istiod-1-20-3-7f6fc6cfd6-s8zfg     1.20.3
...
snip_usage_6() {
istioctl tag set prod-stable --revision 1-20-3 --overwrite
}
...
NAME                                                   CLUSTER        CDS        LDS        EDS        RDS          ECDS         ISTIOD                             VERSION
sleep-5984f48bc7-kmj6x.app-ns-1                        Kubernetes     SYNCED     SYNCED     SYNCED     SYNCED       NOT SENT     istiod-1-20-3-7f6fc6cfd6-jsktb     1.20.3
sleep-78ff5975c6-jldk4.app-ns-3                        Kubernetes     SYNCED     SYNCED     SYNCED     SYNCED       NOT SENT     istiod-1-20-3-7f6fc6cfd6-jsktb     1.20.3
sleep-7cdd8dccb9-5bq5n.app-ns-2                        Kubernetes     SYNCED     SYNCED     SYNCED     SYNCED       NOT SENT     istiod-1-20-3-7f6fc6cfd6-jsktb     1.20.3
ENDSNIP

snip_default_tag_1() {
istioctl tag set default --revision 1-20-3
}
