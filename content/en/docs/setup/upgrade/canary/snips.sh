...
! IFS= read -r -d '' snip_before_you_upgrade_1_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_control_plane_2_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_control_plane_3_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_control_plane_4_out <<\ENDSNIP
NAME                            WEBHOOKS   AGE
...
! IFS= read -r -d '' snip_data_plane_1_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_usage_5_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_usage_8_out <<\ENDSNIP
NAME                                                   CLUSTER        CDS        LDS        EDS        RDS          ECDS         ISTIOD                             VERSION
...
! IFS= read -r -d '' snip_uninstall_old_control_plane_3_out <<\ENDSNIP
NAME                             READY   STATUS    RESTARTS   AGE
