...
istioctl install --revision=1-24-2 --set profile=minimal --skip-confirmation
}

snip_usage_2() {
istioctl tag set prod-stable --revision 1-23-1
istioctl tag set prod-canary --revision 1-24-2
}
...
curl-78ff5975c6-62pzf.app-ns-3      Kubernetes     SYNCED     SYNCED     SYNCED     SYNCED     NOT SENT     istiod-1-24-2-7f6fc6cfd6-s8zfg     1.24.2
...
snip_usage_6() {
istioctl tag set prod-stable --revision 1-24-2 --overwrite
}
...
NAME                                                   CLUSTER        CDS        LDS        EDS        RDS          ECDS         ISTIOD                             VERSION
curl-5984f48bc7-kmj6x.app-ns-1                         Kubernetes     SYNCED     SYNCED     SYNCED     SYNCED       NOT SENT     istiod-1-24-2-7f6fc6cfd6-jsktb     1.24.2
curl-78ff5975c6-jldk4.app-ns-3                         Kubernetes     SYNCED     SYNCED     SYNCED     SYNCED       NOT SENT     istiod-1-24-2-7f6fc6cfd6-jsktb     1.24.2
curl-7cdd8dccb9-5bq5n.app-ns-2                         Kubernetes     SYNCED     SYNCED     SYNCED     SYNCED       NOT SENT     istiod-1-24-2-7f6fc6cfd6-jsktb     1.24.2
ENDSNIP

snip_default_tag_1() {
istioctl tag set default --revision 1-24-2
}
