...
istiod-1-25-1-bdf5948d5-htddg    1/1     Running   0          47s
...
istiod-1-25-1   ClusterIP   10.96.93.151     <none>        15010/TCP,15012/TCP,443/TCP,15014/TCP   109s
...
NAME                            WEBHOOKS   AGE
istio-sidecar-injector-1-25-1   2          2m16s
...
istioctl install --revision=1-26-0 --set profile=minimal --skip-confirmation
}

snip_usage_2() {
istioctl tag set prod-stable --revision 1-25-1
istioctl tag set prod-canary --revision 1-26-0
}
...
curl-78ff5975c6-62pzf.app-ns-3      Kubernetes     SYNCED     SYNCED     SYNCED     SYNCED     NOT SENT     istiod-1-26-0-7f6fc6cfd6-s8zfg     1.26.0
...
snip_usage_6() {
istioctl tag set prod-stable --revision 1-26-0 --overwrite
}
...
NAME                                                   CLUSTER        CDS        LDS        EDS        RDS          ECDS         ISTIOD                             VERSION
curl-5984f48bc7-kmj6x.app-ns-1                         Kubernetes     SYNCED     SYNCED     SYNCED     SYNCED       NOT SENT     istiod-1-26-0-7f6fc6cfd6-jsktb     1.26.0
curl-78ff5975c6-jldk4.app-ns-3                         Kubernetes     SYNCED     SYNCED     SYNCED     SYNCED       NOT SENT     istiod-1-26-0-7f6fc6cfd6-jsktb     1.26.0
curl-7cdd8dccb9-5bq5n.app-ns-2                         Kubernetes     SYNCED     SYNCED     SYNCED     SYNCED       NOT SENT     istiod-1-26-0-7f6fc6cfd6-jsktb     1.26.0
ENDSNIP

snip_default_tag_1() {
istioctl tag set default --revision 1-26-0
}

snip_uninstall_old_control_plane_1() {
istioctl uninstall --revision 1-25-1 -y
}
