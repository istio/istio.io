...
istio-1.19.3/bin/istioctl operator init --revision 1-19-3
}

snip_cat_operator_yaml() {
cat example-istiocontrolplane-1-19-3.yaml
}
...
metadata:
  namespace: istio-system
  name: example-istiocontrolplane-1-19-3
spec:
  revision: 1-19-3
  profile: default
ENDSNIP
...
NAME                             READY   STATUS    RESTARTS   AGE
istiod-1-19-3-597475f4f6-bgtcz   1/1     Running   0          64s
...
istiod-1-19-3   ClusterIP   10.111.17.49     <none>        15010/TCP,15012/TCP,443/TCP,15014/TCP           88s
ENDSNIP
