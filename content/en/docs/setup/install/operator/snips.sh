...
istio-1.23.5/bin/istioctl operator init --revision 1-23-5
}

snip_cat_operator_yaml() {
cat example-istiocontrolplane-1-23-5.yaml
}
...
metadata:
  namespace: istio-system
  name: example-istiocontrolplane-1-23-5
spec:
  revision: 1-23-5
  profile: default
ENDSNIP
...
NAME                             READY   STATUS    RESTARTS   AGE
istiod-1-23-5-597475f4f6-bgtcz   1/1     Running   0          64s
...
istiod-1-23-5   ClusterIP   10.111.17.49     <none>        15010/TCP,15012/TCP,443/TCP,15014/TCP           88s
ENDSNIP
