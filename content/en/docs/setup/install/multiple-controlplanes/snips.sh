...
! IFS= read -r -d '' snip_verify_the_multiple_control_plane_creation_1_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_verify_the_multiple_control_plane_creation_2_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_verify_the_multiple_control_plane_creation_3_out <<\ENDSNIP
NAMESPACE     NAME                                     READY   STATUS    RESTARTS         AGE
...
! IFS= read -r -d '' snip_verify_the_multiple_control_plane_creation_4_out <<\ENDSNIP
NAME                                      WEBHOOKS   AGE
...
! IFS= read -r -d '' snip_verify_the_multiple_control_plane_creation_5_out <<\ENDSNIP
NAME                                             WEBHOOKS   AGE
...
! IFS= read -r -d '' snip_deploy_application_workloads_per_usergroup_4_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_deploy_application_workloads_per_usergroup_5_out <<\ENDSNIP
NAME                      READY   STATUS    RESTARTS   AGE
...
! IFS= read -r -d '' snip_deploy_application_workloads_per_usergroup_6_out <<\ENDSNIP
NAME                      READY   STATUS    RESTARTS   AGE
...
! IFS= read -r -d '' snip_verify_the_application_to_control_plane_mapping_1_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_verify_the_application_to_control_plane_mapping_2_out <<\ENDSNIP
NAME                                 CLUSTER        CDS        LDS        EDS        RDS          ECDS         ISTIOD                                  VERSION
...
! IFS= read -r -d '' snip_verify_the_application_connectivity_is_only_within_the_respective_usergroup_1_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_verify_the_application_connectivity_is_only_within_the_respective_usergroup_2_out <<\ENDSNIP
HTTP/1.1 200 OK
server: envoy
