...
! IFS= read -r -d '' snip_set_up_a_gateway_in_the_external_cluster_3_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_set_up_a_gateway_in_the_external_cluster_5_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_set_up_the_remote_config_cluster_4_out <<\ENDSNIP
NAME                                     WEBHOOKS   AGE
...
! IFS= read -r -d '' snip_set_up_the_remote_config_cluster_5_out <<\ENDSNIP
NAME                              WEBHOOKS   AGE
...
! IFS= read -r -d '' snip_set_up_the_control_plane_in_the_external_cluster_6_out <<\ENDSNIP
NAME                      READY   STATUS    RESTARTS   AGE
...
! IFS= read -r -d '' snip_deploy_a_sample_application_3_out <<\ENDSNIP
NAME                             READY   STATUS    RESTARTS   AGE
...
! IFS= read -r -d '' snip_deploy_a_sample_application_4_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_configure_and_test_an_ingress_gateway_1_out <<\ENDSNIP
NAME                                    READY   STATUS    RESTARTS   AGE
...
! IFS= read -r -d '' snip_configure_and_test_an_ingress_gateway_7_out <<\ENDSNIP
Hello version: v1, instance: helloworld-v1-776f57d5f6-s7zfc
ENDSNIP
...
! IFS= read -r -d '' snip_register_the_new_cluster_5_out <<\ENDSNIP
NAME                                     WEBHOOKS   AGE
...
! IFS= read -r -d '' snip_setup_eastwest_gateways_3_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_setup_eastwest_gateways_4_out <<\ENDSNIP
NAME                    TYPE           CLUSTER-IP    EXTERNAL-IP    PORT(S)   AGE
...
! IFS= read -r -d '' snip_validate_the_installation_3_out <<\ENDSNIP
NAME                            READY   STATUS    RESTARTS   AGE
...
! IFS= read -r -d '' snip_validate_the_installation_4_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_validate_the_installation_5_out <<\ENDSNIP
Hello version: v1, instance: helloworld-v1-776f57d5f6-s7zfc
Hello version: v2, instance: helloworld-v2-54df5f84b-9hxgw
Hello version: v1, instance: helloworld-v1-776f57d5f6-s7zfc
Hello version: v2, instance: helloworld-v2-54df5f84b-9hxgw
