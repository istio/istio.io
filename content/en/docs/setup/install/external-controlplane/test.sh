...
_verify_contains snip_set_up_the_remote_config_cluster_4 "istio-sidecar-injector "
...
_verify_contains snip_register_the_new_cluster_5 "istio-sidecar-injector "
