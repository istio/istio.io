...
- charts in the local file system, e.g., `istioctl install --manifests istio-1.7.0/manifests`
- charts in GitHub, e.g., `istioctl install --manifests https://github.com/istio/istio/releases/download/1.7.0/istio-1.7.0-linux-arm64.tar.gz`
