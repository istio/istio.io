...
! IFS= read -r -d '' snip_installation_steps_4_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_installation_steps_6_out <<\ENDSNIP
NAME       NAMESPACE    REVISION UPDATED         STATUS   CHART         APP VERSION
istio-base istio-system 1        ... ... ... ... deployed base-1.16.1   1.16.1
...
! IFS= read -r -d '' snip_installation_steps_7_out <<\ENDSNIP
NAME: istiod
...
! IFS= read -r -d '' snip_installation_steps_8_out <<\ENDSNIP
...
! IFS= read -r -d '' snip_helm_ls_out <<\ENDSNIP
NAME       NAMESPACE    REVISION UPDATED         STATUS   CHART        APP VERSION
