...
istioctl install --set PILOT_ENABLE_CONFIG_DISTRIBUTION_TRACKING --set values.pilot.env.EXTERNAL_ISTIOD=true --context="${CTX_CLUSTER1}" -f cluster1.yaml
}
...
istioctl install --set PILOT_ENABLE_CONFIG_DISTRIBUTION_TRACKING --context="${CTX_CLUSTER2}" -f cluster2.yaml
}
