...
1.  Deploy the Istio control plane cluster with:
    ...
    * A secret named `cacerts` in the Istio control plane namespace with the
      [Certificate Authority (CA) certificates](/docs/tasks/security/ca-config/plugin-ca-cert/#plugging-in-the-existing-certificate-and-key).
...
1.  Deploy the Istio remote clusters with:
    ...
    * A secret named `cacerts` in the Istio control plane namespace with the
      [CA certificates](/docs/tasks/security/ca-config/plugin-ca-cert/#plugging-in-the-existing-certificate-and-key).
