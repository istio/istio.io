...
function cleanup_cluster2
{
  ...
  kubectl delete mutatingwebhookconfiguration istio-sidecar-injector --context="${CTX_CLUSTER2}"
  #TODO remove ^^^^ when https://github.com/istio/istio/issues/39007 is fixed
