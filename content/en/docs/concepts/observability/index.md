...
### Gathering metrics using Prometheus Operator

If you are using Prometheus Operator to deploy and manage Prometheus, the following PodMonitor and ServiceMonitor can collect metrics from the istio sidecars and the istio control plane.
