...
According to Istio's [support policy](/docs/releases/supported-releases#supported-releases/), LTS releases like 1.7 are supported for three months after the next LTS release. Since [1.8 was released on November 19th](/news/releases/1.8.x/announcing-1.8/), support for 1.7 will end on February 19th, 2021.
