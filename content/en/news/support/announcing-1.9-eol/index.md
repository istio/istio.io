...
According to Istio's [support policy](/docs/releases/supported-releases#supported-releases/), minor releases like 1.9 are supported for three months after the next minor release. Since [1.10 was released on May 18th](/news/releases/1.10.x/announcing-1.10/), support for 1.9 will end on August 24th, 2021.
