---
title: Support for Istio 1.25 ends on September 22, 2025
subtitle: Support Announcement
description: Upcoming Istio 1.25 end of life announcement.
...
At that point we will stop back-porting fixes for security issues and critical bugs to 1.25, so we encourage you to upgrade to the latest version of Istio ({{<istio_release_name>}}). If you don't do this you may put yourself in the position of having to do a major upgrade on a short timeframe to pick up a critical fix.
