...
[Deny Checker](/v1.6/docs/reference/config/policy-and-telemetry/adapters/denier/) and
[List Checker](/v1.6/docs/reference/config/policy-and-telemetry/adapters/list/) feature were affected and those are considered stable features.
