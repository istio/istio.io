...
- **Added** [client-go](https://github.com/istio/client-go) libraries for Istio APIs.

## Installation

- **Added** Added the [operator controller](/docs/ops/setup/standalone-operator/) for dynamic updates to an Istio installation.
