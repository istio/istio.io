...
* Use the [reference docs](/docs/reference/config/) and/or `kubectl explain` (more details below) to confirm and correct the field names and data types.

If you choose to ignore the validation errors, add `--validate=false` to your `kubectl` command when you create or modify Istio resources, we do not, however, recommend doing this.
