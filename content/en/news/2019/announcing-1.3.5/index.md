...
__[CVE-2019-XXXXX](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2019-)__: An infinite loop can be triggered in Envoy if the option `continue_on_listener_filters_timeout` is set to True, which is the case in Istio. This vulnerability could be leveraged for a DoS attack.
