...
Istio 1.22 introduces a new concept known as
...
example, if you want to upgrade to Istio 1.22 but don't want to adopt the changes
...
See https://istio.io/v1.22/docs/reference/config/analysis for more information about
...
[Upgrade Notes](/news/releases/1.22.x/announcing-1.22/upgrade-notes).
