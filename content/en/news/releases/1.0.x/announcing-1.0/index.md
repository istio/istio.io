...
- **Updated Attributes**. The set of [attributes](/v1.6/docs/reference/config/policy-and-telemetry/attribute-vocabulary/) used to describe the source and
...
- **Stackdriver**. The [`stackdriver`](/v1.6/docs/reference/config/policy-and-telemetry/adapters/stackdriver/) adapter has been substantially enhanced in this
