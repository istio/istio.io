...
And then we will not miss any destinationRule dependency.  ([Issue #38082](https://github.com/istio/istio/issues/38082))
...
- **Fixed** unknow field "customService" in v1alpha1.EgressGatewayConfig.
