...
The InferencePool API is now at v1.0.0. In this version. If you're using previous unstable versions of the API, please use the v1 InferencePool API type instead.
