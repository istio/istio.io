...
- **Improved** [Gateway API Automated Deployment](/latest/docs/tasks/traffic-management/ingress/gateway-api/#automated-deployment) management logic. See Upgrade Notes for more information.
