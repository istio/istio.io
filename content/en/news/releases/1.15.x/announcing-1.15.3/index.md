...
- **Fixed** an issue with missing `service_name` in Telemetry API when configuring Datadog tracing provider. ([Issue #38573](https://github.com/istio/istio/issues/38573))
...
- **Fixed** fixed network port forward issue to support IPv4 and IPv6. ([Issue #40605](https://github.com/istio/istio/issues/40605))