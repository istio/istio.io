...
- **Fixed** an issue where many panels in the Grafana dashboards showed **No data** if Prometheus had a scrape
 ...
 ([Background information]( https://grafana.com/blog/2020/09/28/new-in-grafana-7.2-__rate_interval-for-prometheus-rate-queries-that-just-work/) and [usage]( https://istio.io/latest/docs/tasks/observability/metrics/using-istio-dashboard/))
