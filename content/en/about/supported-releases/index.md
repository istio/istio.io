...
description: The current supported Istio releases.
weight: 35
icon: cadence
---

This page lists the status and timelines for currently supported releases. Supported releases of Istio include releases that are in the active
