...
* ~~**No metric expiration for short-lived metrics**~~
  ...
  This expiration mechanism was not available in in-proxy telemetry until
  Istio 1.28.0 with the addition of the
  [`sidecar.istio.io/statsEvictionInterval` annotation](/docs/reference/config/annotations/).
  See also [FAQ: metric expiry](/about/faq/#metric-expiry).
