...
out-of-process extension model called [Mixer](/v1.6/docs/reference/config/policy-and-telemetry/mixer-overview/)
...
written [Mixer adapters](/v1.6/docs/reference/config/policy-and-telemetry/adapters/),
