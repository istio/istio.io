...
description: Configure the IBM Cloud Kubernetes Service Application Load Balancer to direct traffic to an Istio Ingress gateway with mutual TLS.
subtitle: Configure the IBM Cloud Kubernetes Service Application Load Balancer to direct traffic to an Istio Ingress gateway with mutual TLS
