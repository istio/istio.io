...
* The [Basic Access Control](/v1.6/docs/tasks/policy-enforcement/denial-and-list/) task shows how to control access to
  in-mesh services.
* The [Denials and White/Black Listing](/v1.6/docs/tasks/policy-enforcement/denial-and-list/) task shows how to configure
...
for example
[white lists or black lists](/v1.6/docs/tasks/policy-enforcement/denial-and-list/#attribute-based-whitelists-or-blacklists)
...
specified in a [rich expression language](/v1.6/docs/reference/config/policy-and-telemetry/expression-language/), which
...
[`Listchecker` adapter](/v1.6/docs/reference/config/policy-and-telemetry/adapters/list/), its whitelist
