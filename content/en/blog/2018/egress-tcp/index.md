...
[Bookinfo with Mesh Expansion](/docs/examples/vm-bookinfo/) example. In that scenario, a MySQL instance runs on an
external
...
[Istio Mesh Expansion]/docs/tasks/virtual-machines/) instructions for more details.
