...
[Bookinfo with Virtual Machines](/docs/examples/vm-bookinfo/) example. In that scenario, a MySQL instance runs on an
external
...
[Istio VM-related]/docs/tasks/virtual-machines/) tasks for more details.
