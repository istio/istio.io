...
What is interesting here is that the inbound on port 3888 has 127.0.0.1 as its endpoint. This means that Envoy proxy before Istio v1.10 redirects the inbound traffic to the `loopback` interface, as described in the [upcoming networking change in 1.10 blog](/latest/blog/2021/upcoming-networking-changes/).
