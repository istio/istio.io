...
While most of the work for the Product Security Working Group is done behind the scenes, we are listening
to the community in setting expectations for security releases. We understand that it is difficult for service mesh
...
However, when operating Istio it is preferable to plan for possible downtime when upgrading Istio. Given the work
that the Istio community is doing around Day 2 operations in 2021, the Environments working group has done a good
job to streamline many upgrade issues users have seen. The Product Security Working Group intends to help Day 2 operations
by having routine security release days so that upgrade operations can be planned in advance for our users.
...
be shipping soon we are intending to continue this new tradition starting in June.

These releases fix 3 CVEs. Please see the release pages for information regarding the CVEs fixed.
...
at least one of the above methods to be notified of such disclosures.
...
months. We recommend you check it regularly to examine the latest security best practices for Istio. Many of our
recent security bulletins can be mitigated by utilizing items discussed in the Security Best Practices page.
...
apply for membership. Patches for upcoming security release will be made available to the early disclosure list ~2 weeks
...
Our next public meeting will be held on May 25, 2012. Please join us!
