...
This field is what the eastwest gateway uses to forward traffic to the correct mesh application. It needs to match exactly as the listener is defined as shown in the `istioctl` command.
...
For a full demonstration of this in action take a look at the code [here](https://github.com/solo-io/solo-cop/tree//main/blogs/simple-mesh-vms). Follow the [README.md](https://github.com/solo-io/solo-cop/tree/main/blogs/simple-mesh-vms/README.md)
