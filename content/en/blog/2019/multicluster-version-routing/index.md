...
* Set up a multicluster environment with two Istio clusters by following the
    [replicated control planes](/docs/setup/install/multicluster/legacy/gateways/) instructions.
...
As described in the [setup instructions](/docs/setup/install/multicluster/legacy/gateways/#setup-dns),
...
Check out the
[gateway-connected multicluster example](/docs/setup/install/multicluster/legacy/gateways/#configure-the-example-services)
for more details.
