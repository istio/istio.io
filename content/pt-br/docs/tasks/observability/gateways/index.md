...
[Securing Gateways with HTTPS Using Secret Discovery Service task](/pt-br/docs/tasks/traffic-management/ingress/secure-ingress-sds/)
...
1. [Install Istio](/pt-br/docs/setup/install/istioctl) in your cluster and enable the `cert-manager` flag and configure `istio-ingressgateway` to use
...
1. [Install Istio](/pt-br/docs/setup/install/istioctl) in your cluster with your desired telemetry addons.
