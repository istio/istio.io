...
In the default profile, the sampling rate is 1%. Increase it to 100% using the [Telemetry API](/pt-br/docs/tasks/observability/telemetry/):
...
Follow the [SkyWalking installation](/pt-br/docs/ops/integrations/skywalking/#installation) documentation to deploy SkyWalking into your cluster.
...
In this tutorial, we use the [Bookinfo](/pt-br/docs/examples/bookinfo/#deploying-the-application) sample application, in this sample application
