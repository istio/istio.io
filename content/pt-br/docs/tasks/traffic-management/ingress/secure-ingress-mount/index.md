...
sections of the [Control Ingress Traffic](/pt-br/docs/tasks/traffic-management/ingress) task. After performing
...
1.  Configure routes for traffic entering via the `Gateway`. Define the same `VirtualService` as in the [Control Ingress Traffic](/pt-br/docs/tasks/traffic-management/ingress/ingress-control/#configuring-ingress-using-an-istio-gateway) task:
...
1.  Deploy the [Bookinfo sample application](/pt-br/docs/examples/bookinfo/), without a gateway:
