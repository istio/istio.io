...
Istio has an [installation option](/pt-br/docs/reference/config/installation-options/),
...
1.  Check the Mixer log. If Istio is deployed in the `istio-system` namespace, the command to print the log is:
    ...
    [configure Istio to perform TLS origination](/pt-br/docs/tasks/traffic-management/egress/egress-tls-origination/).

### Manage traffic to external services

Similar to inter-cluster requests, Istio
[routing rules](/pt-br/docs/concepts/traffic-management/#routing-rules)
...
or the `global.proxy.excludeIPRanges` [configuration option](/pt-br/docs/reference/config/installation-options/) and
