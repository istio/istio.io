...
ways of injecting the Istio sidecar into a pod: manually using the [`istioctl`](/pt-br/docs/reference/commands/istioctl)
...
use [Helm](/pt-br/docs/setup/install/helm/) to set option `sidecarInjectorWebhook.enabled` to `false`.

There are also a [variety of other options](/pt-br/docs/reference/config/installation-options/#sidecarinjectorwebhook-options) that can be configured.
