...
[Download the new Istio release](/pt-br/docs/setup/getting-started/#download)
and change directory to the new release directory.

### Istio CNI upgrade

If you have installed or are planning to install [Istio CNI](/pt-br/docs/setup/additional-setup/cni/),
...
If you installed Istio CNI using [Helm and Tiller](/pt-br/docs/setup/install/helm/#option-2-install-with-helm-and-tiller-via-helm-install),
...
1. Apply the update templates:
    ...
    You must pass the same settings as when you first [installed Istio](/pt-br/docs/setup/install/helm).
...
{{< tab name="Helm upgrade" category-value="helmupgrade" >}}
If you installed Istio using [Helm and Tiller](/pt-br/docs/setup/install/helm/#option-2-install-with-helm-and-tiller-via-helm-install),
the preferred upgrade option is to let Helm take care of the upgrade.
