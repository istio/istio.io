...
See the [`istioctl` upgrade reference](/pt-br/docs/reference/commands/istioctl/#istioctl-experimental-upgrade)
...
1. Begin the upgrade by running this command:
    ...
    [IstioControlPlane API Custom Resource Definition](/pt-br/docs/setup/install/istioctl/#configure-the-feature-or-component-settings)
