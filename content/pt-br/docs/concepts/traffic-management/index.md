...
[default or sds profiles.](/pt-br/docs/setup/additional-setup/config-profiles/) You
...
-   Logically add services from a different cluster to the mesh to configure a
    [multicluster Istio mesh](/pt-br/docs/setup/install/multicluster/gateways/#configure-the-example-services)
    on Kubernetes.
