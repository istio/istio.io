...
1. Read [Deployment Models](/pt-br/docs/ops/deployment/deployment-models/#multiple-clusters)
...
using [`MeshConfig.serviceSettings`](/pt-br/docs/reference/config/istio.mesh.v1alpha1/#MeshConfig-ServiceSettings-Settings).
...
[`DestinationRule.subsets`](/pt-br/docs/reference/config/networking/destination-rule/#Subset) allows partitioning a service
by selecting labels. These labels can be the labels from Kubernetes metadata, or from [built-in labels](/pt-br/docs/reference/config/labels/).
...
Using these subsets you can create various routing rules based on the cluster such as [mirroring](/pt-br/docs/tasks/traffic-management/mirroring/)
or [shifting](/pt-br/docs/tasks/traffic-management/traffic-shifting/).
...
[`MeshConfig.serviceSettings`](/pt-br/docs/reference/config/istio.mesh.v1alpha1/#MeshConfig-ServiceSettings-Settings),
