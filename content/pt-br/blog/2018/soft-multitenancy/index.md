...
limited multi-tenancy environment. The [docs](/pt-br/docs/) section will be updated
...
The Istio [sidecar](/pt-br/docs/setup/additional-setup/sidecar-injection/)
and [addons](/pt-br/docs/tasks/observability/), if required, manifests must also be
...
See the [Multiple Istio control planes](/pt-br/blog/2018/soft-multitenancy/#multiple-istio-control-planes) section of this document for more details on `namespace` requirements in a
...
that tenant. As an example, updating the [Bookinfo](/pt-br/docs/examples/bookinfo/)
...
If the [add-on tools](/pt-br/docs/tasks/observability/), example
[Prometheus](/pt-br/docs/tasks/observability/metrics/querying-metrics/), are deployed
