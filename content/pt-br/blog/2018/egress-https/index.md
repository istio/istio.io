...
In this blog post, I modify the [Istio Bookinfo Sample Application](/pt-br/docs/examples/bookinfo/) to fetch book details from
...
To demonstrate the scenario of consuming an external web service, I start with a Kubernetes cluster with [Istio installed](/pt-br/docs/setup/getting-started/). Then I deploy
[Istio Bookinfo Sample Application](/pt-br/docs/examples/bookinfo/). This application uses the _details_ microservice to fetch
...
[mutual TLS](/pt-br/docs/concepts/security/#mutual-tls-authentication) enabled. The Bookinfo configuration files reside in the
...
[Deploying the application](/pt-br/docs/examples/bookinfo/#deploying-the-application),
[Confirm the app is running](/pt-br/docs/examples/bookinfo/#confirm-the-app-is-accessible-from-outside-the-cluster),
[Apply default destination rules](/pt-br/docs/examples/bookinfo/#apply-default-destination-rules)
sections, and
...
Note that the virtual service relies on a destination rule that you created in the [Apply default destination rules](/pt-br/docs/examples/bookinfo/#apply-default-destination-rules) section.
...
[mesh-external service entry](/pt-br/docs/reference/config/networking/service-entry/).
...
inside or outside an Istio service mesh. This contradicts the Istio design goal of [maximizing transparency](/pt-br/docs/ops/deployment/architecture/#design-goals). Sometimes you need to compromise...
...
[the mutual TLS](/pt-br/docs/concepts/security/#mutual-tls-authentication) applied by Istio. The TLS origination for the
