...
[v1alpha3 traffic management API](/pt-br/blog/2018/v1alpha3-routing/). If you need to use the old version, follow these [docs](https://archive.istio.io/v0.7/blog/2018/egress-tcp.html).
{{< /tip >}}

In my previous blog post, [Consuming External Web Services](/pt-br/blog/2018/egress-https/), I described how external services
...
As in [Consuming External Web Services](/pt-br/blog/2018/egress-https/), you experience **graceful service degradation**,
...
You have the same problem as in [Consuming External Web Services](/pt-br/blog/2018/egress-https/), namely all the traffic
...
[Bookinfo with Virtual Machines](/pt-br/docs/examples/virtual-machines/) example. In that scenario, a MySQL instance runs on an
external
