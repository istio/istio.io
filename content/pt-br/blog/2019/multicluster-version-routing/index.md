...
* Set up a multicluster environment with two Istio clusters by following the
    [replicated control planes](/pt-br/docs/setup/install/multicluster/gateways/) instructions.
...
As described in the [setup instructions](/pt-br/docs/setup/install/multicluster/gateways/#setup-dns),
...
Check out the
[gateway-connected multicluster example](/pt-br/docs/setup/install/multicluster/gateways/#configure-the-example-services)
for more details.
