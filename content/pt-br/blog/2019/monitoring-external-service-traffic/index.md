...
metrics](/pt-br/docs/reference/config/policy-and-telemetry/metrics) are augmented with
...
* **BlackHoleCluster** - The BlackHoleCluster is a virtual cluster created
  ...
  The route is setup as [direct response](https://www.envoyproxy.io/docs/envoy/latest/api-v2/api/v2/route/route_components.proto#envoy-api-msg-route-directresponseaction)
