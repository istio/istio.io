...
For Istio 1.1.x deployments: update to a minimum of [Istio 1.1.2](/pt-br/news/releases/1.1.x/announcing-1.1.2)

For Istio 1.0.x deployments: update to a minimum of [Istio 1.0.7](/pt-br/news/releases/1.0.x/announcing-1.0.7)
