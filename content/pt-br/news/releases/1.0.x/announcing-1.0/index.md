...
- [Helm chart installation](/pt-br/docs/setup/install/helm/) is now the recommended install method offering rich customization options to adopt Istio on your terms.
...
to go deeper and [contribute to the project](/pt-br/about/community) come to one of our community meetings and say hello.
...
- Added the [`istioctl authn tls-check`](/pt-br/docs/reference/commands/istioctl/#istioctl-authn-tls-check) command.
...
- Amazon's EKS service does not implement automatic sidecar injection.  Istio can be used in Amazon's
  ...
  sidecars and turning off galley using the [Helm parameter](/pt-br/docs/setup/install/helm)
