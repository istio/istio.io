...
to deliver timely improvements. See [here](/pt-br/about/feature-stages/) for information on the state of individual features
for this release.
...
[configuration options](/pt-br/docs/reference/config/policy-and-telemetry/adapters/list/) for details.
