...
Then follow the steps of the [cleanup section of the Distributed Tracing task](/pt-br/docs/tasks/observability/distributed-tracing/zipkin/#cleanup).

If you don’t want tracing functionality at all, then [disable tracing](/pt-br/docs/tasks/observability/distributed-tracing/zipkin/#before-you-begin) when installing Istio.
