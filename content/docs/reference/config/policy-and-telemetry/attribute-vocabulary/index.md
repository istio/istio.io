...
| `context.proxy_error_code` | string | Additional details about the response or connection from envoy. See %RESPONSE_FLAGS% in [envoy access log](https://www.envoyproxy.io/docs/envoy/latest/configuration/access_log#configuration) for more detail | `UH` |
