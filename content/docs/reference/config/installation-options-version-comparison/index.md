---
title: Release Comparison of Helm Installation Options
...
- The existing installation options that remain unchanged.
...
### Unmodified `servicegraph` key/value pairs
...
### Unmodified `tracing` key/value pairs
...
### Unmodified `sidecarInjectorWebhook` key/value pairs
...
### Unmodified `global` key/value pairs
...
### Unmodified `galley` key/value pairs
...
### Unmodified `mixer` key/value pairs
...
### Unmodified `grafana` key/value pairs
...
### Unmodified `prometheus` key/value pairs
...
### Unmodified `gateways` key/value pairs
...
### Unmodified `certmanager` key/value pairs
...
### Unmodified `kiali` key/value pairs
...
### Unmodified `security` key/value pairs
...
### Unmodified `pilot` key/value pairs
