...
Istio security and [SPIRE](https://spiffe.io/spire/), which is the implementation of SPIFFE,
differ in the [Public Key Infrastructure](https://en.wikipedia.org/wiki/Public_key_infrastructure) (PKI) implementation details.
Istio provides a more comprehensive security solution, including authentication, authorization, and auditing.

## PKI

The Istio [Public Key Infrastructure](https://en.wikipedia.org/wiki/Public_key_infrastructure) (PKI) is built on top of Istio Citadel
and securely provisions strong workload identities to every workload.
