...
description: Learn about Istio's dynamic failure recovery features that you can configure to build tolerance for failing nodes, and to prevent cascading failures to other nodes.
weight: 3
