...
> Starting with Istio 0.7, you can use [authentication policy](/docs/concepts/security/#authorization) to configure mutual TLS for all/selected services in a namespace (repeated for all namespaces to get global setting). See [authentication policy task](/docs/tasks/security/authn-policy/)
