...
Today the keys and certificates of Istio workloads are generated by Citadel and distributed to sidecars
...
To solve the above issues, starting from 1.1 release, Istio supports identity provision through SDS(secret discovery service).
...
SDS API, node agent generates private key and send CSR request to Citadel, Citadel verifies the JWT and signs the certificate,
