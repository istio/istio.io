...
> Starting with Istio 0.7, you can use [authentication policy](/docs/concepts/security/#authentication) to configure mutual TLS for all/selected services in a namespace
