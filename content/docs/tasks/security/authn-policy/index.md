...
* Understand Istio [authentication policy](/docs/concepts/security/#authorization) and related [mutual TLS authentication](/docs/concepts/security/#authentication) concepts.
