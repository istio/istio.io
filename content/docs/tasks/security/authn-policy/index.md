...
* Understand Istio [authentication policy](/docs/concepts/security/#authentication) and related [mutual TLS authentication](/docs/concepts/security/#mutual-tls-authentication) concepts.
