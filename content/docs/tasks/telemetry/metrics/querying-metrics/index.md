...
1. `istio-telemetry.istio-system:10514`: The `istio-telemetry` job returns all Mixer-specific metrics. Use this endpoint to monitor Mixer itself.
...
1. `istio-pilot.istio-system:10514`: The `pilot` job returns the Pilot-generated metrics.
1. `istio-galley.istio-system:10514`: The `galley` job returns the Galley-generated metrics.
1. `istio-policy.istio-system:10514`: The `istio-policy` job returns all policy-related metrics.
