...
1. Individual Services View. This section provides metrics about requests and
   ...
   This also gives metrics about client and service workloads for this service.
...
1. Individual Workloads View: This section provides metrics about requests and
   ...
   This also gives metrics about inbound workloads and outbound services for this workload.
