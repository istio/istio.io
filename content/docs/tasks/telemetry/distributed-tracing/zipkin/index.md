...
1.  To set up Istio, follow the instructions in the [Installation guide](/docs/setup/kubernetes/helm-install/).

    Use the following Helm install options to enable tracing and select the `zipkin` tracing provider:
