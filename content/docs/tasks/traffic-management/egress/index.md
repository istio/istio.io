...
To implement egress traffic control in a secure way, you must [direct egress traffic through an egress gateway](/docs/examples/advanced-egress/egress-gateway) and address the security concerns expressed in
[Configure an Egress Gateway example, Additional Security Considerations](/docs/examples/advanced-egress/egress-gateway#additional-security-considerations).
