...
1. (Optionally) if you are enabling `certmanager`, you also need to install `certmanager`'s CRDs as well and wait a few seconds for the CRDs to be committed in the kube-apiserver:
