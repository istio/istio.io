...
1. Choose one of the following two **mutually exclusive** options described below.
    ...
    * To to deploy Istio without using Tiller, follow the instructions for [option 1](/docs/setup/kubernetes/helm-install/#option-1-install-with-helm-via-helm-template).
