...
* The IP address of the Istio ingressgateway in each cluster must be accessible
...
* A **Root CA**. Cross cluster communication requires mTLS connection
  ...
  pre-generated root CA certificate available as part of Istio install
...
pre-configured and installed as part of the Istio installation step
