---
title: With VPN
description: Istio mesh spanning multiple Kubernetes clusters with direct network access to remote pods over VPN.
weight: 5
...
1. _(Optional)_  Create file with environment variables for creating the remote cluster secret:
