...
If you use service annotations to override global mutual TLS enablement for a service, you need to replace it with [authentication policy](/docs/concepts/security/#authentication) and [destination rules](/docs/concepts/traffic-management/#destination-rules).
