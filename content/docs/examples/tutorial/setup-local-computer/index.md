...
1.  Store the configuration from the previous Setup module in the `KUBECONFIG` environment variable.

    {{< text bash >}}
    $ export KUBECONFIG=./${NAMESPACE}-user-config.yaml
    {{< /text >}}

Congratulations! You have a Kubernetes cluster ready for learning and you set up your local computer. Proceed to the
next module to start actual learning. Enjoy!
