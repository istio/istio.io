...
You may choose to upgrade to 1.0.8 or 1.1.8 or later versions to avoid this problem in the future.
...
### Can I upgrade to 1.0.8 or 1.1.8 first, and then do the root transition?

Yes, you can. You can upgrade to 1.0.8 or 1.1.8 as normal.
...
Please make sure you have updated to 1.0.8 or 1.1.8 for the `istio-proxy` sidecars in Step 4.
...
This may happen if you did not upgrade to 1.0.8 or 1.1.8.
