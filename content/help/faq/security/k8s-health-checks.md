...
work since kubelet does not have Istio-issued certs. A workaround is to
...
If you do not want to modify the configure file, you can enable the `PERMISSIVE`
mode for your services such they can accept both http and mutual TLS traffic. As
a result, the health check will not break. Refer [Health checking of Istio
