...
Starting with Istio 0.8, [authentication policy](/docs/concepts/security/#authorization) can be used to change mutual TLS setting at run time, without needing to reinstall Istio.
