...
- The Istio project recommends a manual upgrade of the control plane and data plane to 1.1. See
...
- **CRD Install Separated from Istio Install**.  Istio’s CRDs have been placed into their own Helm chart `istio-init`.
  By placing CRDs in their own Helm chart, data continuity of custom resource content is preserved during the upgrade process
  and further enables the Istio project to evolve beyond a Helm-based installation.
