...
从 Istio 1.0 版本开始，我们对 Istio 服务支持 [`PERMISSIVE` mode](/docs/tasks/security/mtls-migration)
...
另一种解决方法是对健康检查使用 [liveness 命令](https://kubernetes.io/docs/tasks/configure-pod-container/configure-liveness-readiness-probes/#define-a-liveness-command)，例如，可以在服务 pod 中安装 `curl`
`curl` 本身在 pod 内。
