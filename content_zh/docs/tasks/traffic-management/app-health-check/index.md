...
* 了解 [Kubernetes liveness 和 readiness 探针](https://kubernetes.io/docs/tasks/configure-pod-container/configure-liveness-readiness-probes/)，Istio [认证策略](/docs/concepts/security/#authentication-policy)和[双向 TLS 认证](/docs/concepts/security/#mutual-tls-authentication)的概念。
