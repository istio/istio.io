...
1. 遵循[部署 Bookinfo 示例应用程序说明](/zh/docs/examples/bookinfo/#deploying-the-application)。

## 可视化追踪数据

1. 遵循[为 Bookinfo 应用创建 ingress gateway 的说明](/zh/docs/examples/bookinfo/#determining-the-ingress-ip-and-port)。
...
1. 要删除 Bookinfo 应用程序，请参考 [Bookinfo 清理](/zh/docs/examples/bookinfo/#cleanup)说明。
