...
1. *envoy* (`istio-proxy:15090`): envoy 生成的原始统计数据 。

Prometheus 从 envoy 暴露的端口获取统计数据，过滤掉不想要的数据。有关查询 Prometheus 的更多信息，请阅读他们的[查询文档](https://prometheus.io/docs/querying/basics/)。
