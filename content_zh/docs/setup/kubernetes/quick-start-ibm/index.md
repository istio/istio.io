...
{{< image link="/docs/setup/kubernetes/install/quick-start-ibm/istio-catalog-1.png" caption="IBM 私有云 - Istio 目录" >}}

- 点击右侧面板中的 `ibm-istio`。

{{< image link="/docs/setup/kubernetes/install/quick-start-ibm/istio-catalog-2.png" caption="IBM 私有云 - Istio 目录" >}}

- （可选的）使用 `CHART VERSION` 的下拉功能修改 Istio 版本。
- 点击 `Configure` 按钮。

{{< image link="/docs/setup/kubernetes/install/quick-start-ibm/istio-installation-1.png" caption="IBM 私有云 - 安装 Istio" >}}
...
{{< image link="/docs/setup/kubernetes/install/quick-start-ibm/istio-installation-2.png" caption="IBM 私有云 - 安装 Istio" >}}

安装完成后，你可以在 **Helm Releases** 页通过搜索实例名找到它。

{{< image link="/docs/setup/kubernetes/install/quick-start-ibm/istio-release.png" caption="IBM 私有云 - 安装 Istio" >}}
...
{{< image link="/docs/setup/kubernetes/install/quick-start-ibm/istio-upgrade-1.png" caption="IBM 私有云 - Istio 升级或回滚" >}}

{{< image link="/docs/setup/kubernetes/install/quick-start-ibm/istio-upgrade-2.png" caption="IBM 私有云 - Istio 升级或回滚" >}}
...
{{< image link="/docs/setup/kubernetes/install/quick-start-ibm/istio-deletion.png" caption="IBM 私有云 - 卸载 Istio" >}}
