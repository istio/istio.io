...
{{< image width="80%" link="/docs/setup/kubernetes/advanced-install/multicluster-install/gateways/multicluster-with-gateways.svg" caption="Istio 网格使用 Istio Gateway 跨越多个 Kubernetes 集群访问远程 pod" >}}
