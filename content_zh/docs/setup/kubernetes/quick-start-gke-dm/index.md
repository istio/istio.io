...
{{< image link="/docs/setup/kubernetes/install/quick-start-gke/dm_gcp_iam.png" caption="GKE-IAM Service" >}}

然后添加 `Kubernetes Engine Admin` 角色:

{{< image width="70%" link="/docs/setup/kubernetes/install/quick-start-gke/dm_gcp_iam_role.png" caption="GKE-IAM Role" >}}
...
1.  点击 **Deploy**:
    ...
    {{< image link="/docs/setup/kubernetes/install/quick-start-gke/dm_launcher.png" caption="GKE-Istio Launcher" >}}
...
{{< image width="70%" link="/docs/setup/kubernetes/install/quick-start-gke/dm_kubernetes_workloads.png" caption="GKE-Workloads"  >}}
...
1.  确认一下你可以访问 Bookinfo `http://${GATEWAY_URL}/productpage`:
    ...
    {{< image link="/docs/setup/kubernetes/install/quick-start-gke/dm_bookinfo.png" caption="Bookinfo" >}}
...
{{< image link="/docs/setup/kubernetes/install/quick-start-gke/dm_grafana.png" caption="Grafana" >}}
...
{{< image link="/docs/setup/kubernetes/install/quick-start-gke/dm_prometheus.png" caption="Prometheus" >}}
...
{{< image link="/docs/setup/kubernetes/install/quick-start-gke/dm-tracing.png" caption="Tracing Dashboard" >}}
