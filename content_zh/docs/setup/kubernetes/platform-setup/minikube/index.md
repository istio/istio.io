...
1. 选择一个[虚拟机驱动](https://kubernetes.io/docs/setup/minikube/#quickstart)，安装之后，这里假设所选驱动为 `your_vm_driver_choice`，完成下面的步骤，要安装 Istio 控制面板组件、插件以及其他应用程序，我们建议使用内存大小为 8192 `MB` 和拥有`CPU`数量为4的机器:
