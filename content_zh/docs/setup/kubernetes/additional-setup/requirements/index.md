...
* _**Pod 端口**:_ Pods must include an explicit list of ports each container will listen on.
...
* _**`NET_ADMIN` capability**:_ If pod security policies are enforced in your cluster and unless you use the [Istio CNI Plugin](/zh/docs/setup/kubernetes/install/cni/), your pods must have the `NET_ADMIN` capability allowed.
