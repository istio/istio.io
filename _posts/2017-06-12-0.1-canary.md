---
title: "Autoscaled Canary Deployment with Istio"
overview: Canary deployment using Istio
published: true
permalink: ????
attribution: ???? My name or "The Istio Team"
layout: post
type: markdown
redirect_from: ????
---
...
Intelligent routing in support of canary deployment is just one of the many features of Istio that will make the production deployment of large-scale microservices-based applications much simpler. Check out [istio.io](https://istio.io/) for more about information and to try it out.
