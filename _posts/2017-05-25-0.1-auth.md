...
Istio Auth is the security component of the broader [Istio platform](https://istio.io/). It incorporates the learnings of securing endpoints all across Google’s production environment.
