...
However, since we are going to deploy the service in an [Istio enabled]({{home}}/docs/tasks/installing-istio-in-kubernetes.html) cluster, all we need to do is set a routing
