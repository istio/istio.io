...
Good news is that our application did not crash. As in a good microservice design, we do not have error propagation, that is, the failing _details_ microservice does not cause the _productpage_ microservice to fail. Most of the functionality of the application is still provided, in this case the reviews and the ratings are displayed correctly.
