...
require (
	...
	istio.io/istio v0.0.0-20220815143345-5c96eb94085f
...
require (
	...
	istio.io/api v0.0.0-20220812173711-367d0a244995 // indirect
	istio.io/client-go v1.14.4-0.20220812174212-ec2696c341a4 // indirect
