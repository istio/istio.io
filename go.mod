...
require (
	...
	istio.io/istio v0.0.0-20230819064606-0ef5c4154801
...
require (
	...
	istio.io/api v1.19.0-beta.0.0.20230818164305-624ffbd0a0a3 // indirect
	istio.io/client-go v1.19.0-beta.0.0.20230819055407-f997891e9264 // indirect
