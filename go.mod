...
require (
	...
	istio.io/istio v0.0.0-20230502151635-ec8ef6db67c6
...
require (
	...
	istio.io/api v0.0.0-20230501175934-60fc5e350b73 // indirect
	istio.io/client-go v1.18.0-alpha.0.0.20230501180834-5efb26b05cfd // indirect
