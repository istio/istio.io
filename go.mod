...
require (
	...
	istio.io/istio v0.0.0-20220812060356-6428b12aa23c
...
require (
	...
	istio.io/api v0.0.0-20220811215546-8fcc87705eeb // indirect
	istio.io/client-go v1.15.0-beta.0.0.20220811215945-34189472863f // indirect
