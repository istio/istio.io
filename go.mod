...
require (
	...
	istio.io/istio v0.0.0-20221007020814-bc01b673461e
...
require (
	...
	istio.io/api v0.0.0-20221004225839-607aeaab2827 // indirect
	istio.io/client-go v1.14.5-0.20221004230640-0f4eee98e01b // indirect
