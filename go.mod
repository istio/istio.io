...
require (
	...
	istio.io/istio v0.0.0-20230708202334-6cd503a14d58
...
require (
	...
	istio.io/api v1.19.0-alpha.1.0.20230707182832-df0d3338f45a // indirect
	istio.io/client-go v1.19.0-alpha.1.0.20230707183633-3e6aaa13c63c // indirect
