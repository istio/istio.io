...
require (
	...
	istio.io/istio v0.0.0-20230624210328-f63ff906a990
...
require (
	...
	istio.io/api v0.0.0-20230623150004-4f4d2c086b9a // indirect
	istio.io/client-go v1.18.0-alpha.0.0.20230623150704-be13fb8cf357 // indirect
