...
require (
	...
	istio.io/istio v0.0.0-20240419122843-745cdaa0dfdb
...
require (
	...
	istio.io/api v1.19.9-0.20240405183623-c4a79179e7d2 // indirect
	istio.io/client-go v1.19.9-0.20240405184322-ef7f04bc53b3 // indirect
