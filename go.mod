...
require (
	...
	istio.io/istio v0.0.0-20230711141354-720960697d26
...
require (
	...
	istio.io/api v1.19.0-alpha.1.0.20230710184836-89542d362cbe // indirect
	istio.io/client-go v1.19.0-alpha.1.0.20230710185637-8d91a6644a60 // indirect
