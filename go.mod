...
require (
	...
	istio.io/istio v0.0.0-20230510102134-f52f1ea3b0e9
...
require (
	...
	istio.io/api v0.0.0-20230503140801-e80b3c49cd25 // indirect
	istio.io/client-go v1.18.0-beta.0.0.20230503141602-be654414c34b // indirect
