...
require (
	...
	istio.io/istio v0.0.0-20240125073703-db553bed81f7
...
require (
	...
	istio.io/api v1.19.0-alpha.1.0.20240125064802-09960290362d // indirect
	istio.io/client-go v1.20.0-beta.0 // indirect
