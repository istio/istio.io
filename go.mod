...
require (
	...
	istio.io/istio v0.0.0-20260911202649-08d1f68a1823
...
require (
	...
	istio.io/api v1.31.0-alpha.1.0.20260911193850-60e797733e7e // indirect
	...
	sigs.k8s.io/gateway-api/conformance v1.6.1 // indirect
