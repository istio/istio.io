...
require (
	...
	istio.io/istio v0.0.0-20230918041552-d02779cf20e7
...
require (
	...
	istio.io/api v1.19.0-alpha.1.0.20230915171951-f6fb1c4ef5d0 // indirect
	istio.io/client-go v1.19.0-alpha.1.0.20230915172352-63410b5c157a // indirect
