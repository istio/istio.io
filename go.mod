...
require (
	...
	istio.io/istio v0.0.0-20220423182552-a19a84e9d0f6
...
require (
	...
	istio.io/api v0.0.0-20220422190951-7285329dce57 // indirect
	istio.io/client-go v1.12.0-alpha.5.0.20220422191450-3ab45a1ca18d // indirect
