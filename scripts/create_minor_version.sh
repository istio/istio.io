...
echo ""
echo "Next steps:"
echo "1. Merge the release branch PR in istio.io"
echo "2. Ask the docs WG to point staging.istio.io to the new release branch"
echo "3. Verify that the staging website is correct"
echo "4. Publish the new minor version"
