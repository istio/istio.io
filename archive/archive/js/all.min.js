...
"use strict";const languages=["en","zh","pt-br"];function handleLanguageSwitch(){function a(a){const b=new URL(window.location.href);let c=b.pathname,d=0;for(const b of languages){if(c.startsWith("/"+b)){c=c.substr(3);break}d++}if(d>=languages.length&&(d=0),""===a){let b=d+1;b>=languages.length&&(b=0),a=languages[b]}createCookie("nf_lang",a),b.pathname=a+"/"+c,navigateToUrlOrRoot(b.toString())}listen(getById("switch-lang"),click,()=>(a(""),!0));for(const b of languages)listen(getById("switch-lang-"+b),click,()=>{a(b)})}handleLanguageSwitch();
