...
istioctl install --set values.pilot.env.PILOT_ENABLE_CONFIG_DISTRIBUTION_TRACKING=true --revision=1-19-4 --set profile=minimal --skip-confirmation
}

snip_usage_2() {
istioctl tag set prod-stable --revision 1-18-1
istioctl tag set prod-canary --revision 1-19-4
}
...
sleep-78ff5975c6-62pzf.app-ns-3     Kubernetes     SYNCED     SYNCED     SYNCED     SYNCED     NOT SENT     istiod-1-19-4-7f6fc6cfd6-s8zfg     1.19.4
